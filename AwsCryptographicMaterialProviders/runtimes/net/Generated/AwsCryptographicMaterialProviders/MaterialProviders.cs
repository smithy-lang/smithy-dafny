...
using software.amazon.cryptography.materialproviders.internaldafny.types;
namespace AWS.Cryptography.MaterialProviders
{
  public class MaterialProviders
  {
    ...
    public AWS.Cryptography.MaterialProviders.ICryptographicMaterialsManager CreateRequiredEncryptionContextCMM(AWS.Cryptography.MaterialProviders.CreateRequiredEncryptionContextCMMInput input)
    {
      software.amazon.cryptography.materialproviders.internaldafny.types._ICreateRequiredEncryptionContextCMMInput internalInput = TypeConversion.ToDafny_N3_aws__N12_cryptography__N17_materialProviders__S39_CreateRequiredEncryptionContextCMMInput(input);
      Wrappers_Compile._IResult<software.amazon.cryptography.materialproviders.internaldafny.types.ICryptographicMaterialsManager, software.amazon.cryptography.materialproviders.internaldafny.types._IError> result = _impl.CreateRequiredEncryptionContextCMM(internalInput);
      if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
