...
public class CreateAwsKmsMultiKeyringInput {
  ...
  /**
   * A identifier for a symmetric AWS KMS Key responsible for wrapping and unwrapping data keys.
   * KMS.GenerateDataKey may be called with this key if the data key has not already been generated
   * by another Keyring. This should not be a AWS KMS Multi-Region Key.
   */
  private final String generator;

  /**
   * A list of identifiers for the symmetric AWS KMS Keys (other than the generator) responsible for
   * wrapping and unwrapping data keys. This list should not contain AWS KMS Multi-Region Keys.
   */
  ...
  /**
   * @return A identifier for a symmetric AWS KMS Key responsible for wrapping and unwrapping data
   *     keys. KMS.GenerateDataKey may be called with this key if the data key has not already been
   *     generated by another Keyring. This should not be a AWS KMS Multi-Region Key.
   */
  ...
  /**
   * @return A list of identifiers for the symmetric AWS KMS Keys (other than the generator)
   *     responsible for wrapping and unwrapping data keys. This list should not contain AWS KMS
   *     Multi-Region Keys.
   */
  ...
  public interface Builder {
    /**
     * @param generator A identifier for a symmetric AWS KMS Key responsible for wrapping and
     *     unwrapping data keys. KMS.GenerateDataKey may be called with this key if the data key has
     *     not already been generated by another Keyring. This should not be a AWS KMS Multi-Region
     *     Key.
     */
    ...
    /**
     * @return A identifier for a symmetric AWS KMS Key responsible for wrapping and unwrapping data
     *     keys. KMS.GenerateDataKey may be called with this key if the data key has not already
     *     been generated by another Keyring. This should not be a AWS KMS Multi-Region Key.
     */
    String generator();

    /**
     * @param kmsKeyIds A list of identifiers for the symmetric AWS KMS Keys (other than the
     *     generator) responsible for wrapping and unwrapping data keys. This list should not
     *     contain AWS KMS Multi-Region Keys.
     */
