...
module {:extern "software.amazon.cryptography.materialproviders.internaldafny.types" } AwsCryptographyMaterialProvidersTypes
{
  ...
  datatype CreateAwsKmsHierarchicalKeyringInput = | CreateAwsKmsHierarchicalKeyringInput (
    ...
    nameonly trackerSettings: Option<StormTrackerSettings>
  )
  ...
  datatype SignatureAlgorithm =
    | ECDSA(ECDSA: ECDSA)
    | None(None: None)
  datatype StormTrackerSettings = | StormTrackerSettings (
    nameonly gracePeriod: PositiveInteger ,
    nameonly graceInterval: PositiveInteger ,
    nameonly fanOut: PositiveInteger ,
    nameonly inFlightTTL: PositiveInteger ,
    nameonly sleepMilli: PositiveInteger
  )
