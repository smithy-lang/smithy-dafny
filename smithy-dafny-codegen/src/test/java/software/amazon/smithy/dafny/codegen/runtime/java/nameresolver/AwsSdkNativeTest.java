...
public class AwsSdkNativeTest {
    ...
    public void testTypeForStructure() {
        final TypeName expected = ClassName.bestGuess("com.amazonaws.services.kms.model.DoSomethingRequest");
    ...
    public void testTypeForServiceKMS() {
        final TypeName expected = ClassName.bestGuess("com.amazonaws.services.kms.AWSKMS");
        final TypeName actual = underTest.typeForShape(
