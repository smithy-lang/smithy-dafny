...
import software.amazon.smithy.dafny.codegen.util.Tokenizer;
...
import static software.amazon.smithy.dafny.codegen.runtime.dotnet.TypeConversionDirection.*;
...
public class ShimCodegenTest {
    ...
    public void testGenerateResourceShim() {
        ...
        final String commonErrorTypeConverter = codegen.getNameResolver()
