...
public class TestModel {
     ...
     */
    public static Model setupModel(final BiConsumer<ServiceShape.Builder, ModelAssembler> updater) {
    ...
    public static Model setupModel() {
        return setupModel((ServiceShape.Builder _builder, ModelAssembler _assembler) -> {});
    }
    ...
    public static StructureShape setupFoobarStructureShape() {
        return StructureShape.builder()
                ...
                .addMember("someBool", ShapeId.from("smithy.api#Boolean"), memberUpdater -> memberUpdater.addTrait(new RequiredTrait()))
                .build();
    }
}
