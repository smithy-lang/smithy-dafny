...
import software.amazon.smithy.dafny.codegen.runtime.java.ModelConstants;
import software.amazon.smithy.dafny.codegen.runtime.java.generator.awssdk.TestSetupUtils;
...
public class ToNativeTest {
    ...
    public void conversionMethodReference() {
        ...
        String otherNamespaceActualString = otherNamespaceActual.asNormalReference().toString();
    ...
    public void generateConvertEnum() {
        ...
        String expected = ToNativeConstants.KEY_USAGE_TYPE;
        tokenizeAndAssertEqual(expected, actual.toString());
    }
    ...
    public void generateConvert() {
        ...
        tokenizeAndAssertEqual(ToNativeConstants.KEY_USAGE_TYPE, underTest.generateConvert(enumId).toString());
        // case LIST
        ShapeId listId = ShapeId.fromParts("com.amazonaws.kms", "KeyUsageTypes");
