package software.amazon.smithy.dafny.codegen.runtime.java.generator.library.shims;
    ...
    protected MethodSpec operation(OperationShape operationShape) {
        ...
        if (outputResolved.resolvedId().equals(Constants.SMITHY_API_UNIT)) {
            ...
            method
                    ...
                    .addStatement("return $T.create_Success($T.create())",
                            Constants.DAFNY_RESULT_CLASS_NAME, Constants.DAFNY_TUPLE0_CLASS_NAME);
        } else {
            ...
            method
                    ...
                    .addStatement("return $T.create_Success($L)",
                            Constants.DAFNY_RESULT_CLASS_NAME, DAFNY_OUTPUT);
        }
        ...
        method
                ...
                .addStatement("return $T.create_Failure($T.Error(ex))",
                        Constants.DAFNY_RESULT_CLASS_NAME, toDafnyClassName);
