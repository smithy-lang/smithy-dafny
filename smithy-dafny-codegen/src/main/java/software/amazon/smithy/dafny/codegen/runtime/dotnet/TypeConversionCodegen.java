...
import software.amazon.smithy.dafny.codegen.DafnyNameResolver;
import software.amazon.smithy.dafny.codegen.runtime.dotnet.localServiceWrapper.LocalServiceWrappedNameResolver;
import software.amazon.polymorph.traits.*;
import software.amazon.smithy.dafny.codegen.traits.*;
import software.amazon.smithy.dafny.codegen.utils.ModelUtils;
...
import software.amazon.smithy.polymorph.traits.*;
...
public class TypeConversionCodegen {
    ...
    public static final Path TYPE_CONVERSION_CLASS_PATH = Path.of(DotNetNameResolver.TYPE_CONVERSION_CLASS_NAME + ".cs");
    ...
    public Map<Path, TokenTree> generate() {
        ...
        final TokenTree conversionClass = conversionClassBody
                .prepend(TokenTree.of("public static class", DotNetNameResolver.TYPE_CONVERSION_CLASS_NAME))
    ...
    public TypeConverter generateListConverter(final ListShape listShape) {
        ...
        final String memberToDafnyConverterName = DotNetNameResolver.typeConverterForShape(memberShape.getId(), TypeConversionDirection.TO_DAFNY);
        final String memberFromDafnyConverterName = DotNetNameResolver.typeConverterForShape(memberShape.getId(), TypeConversionDirection.FROM_DAFNY);
    ...
    public TypeConverter generateMapConverter(final MapShape mapShape) {
        ...
        final String keyToDafnyConverterName = DotNetNameResolver.typeConverterForShape(keyShape.getId(), TypeConversionDirection.TO_DAFNY);
        final String keyFromDafnyConverterName = DotNetNameResolver.typeConverterForShape(keyShape.getId(), TypeConversionDirection.FROM_DAFNY);
        final String valueToDafnyConverterName = DotNetNameResolver.typeConverterForShape(valueShape.getId(), TypeConversionDirection.TO_DAFNY);
        final String valueFromDafnyConverterName = DotNetNameResolver.typeConverterForShape(valueShape.getId(), TypeConversionDirection.FROM_DAFNY);
        ...
        final TokenTree assignments = TokenTree.of(ModelUtils.streamStructureMembers(structureShape)
                .map(memberShape -> {
                    ...
                    final String memberFromDafnyConverterName = DotNetNameResolver.typeConverterForShape(
                            memberShape.getId(), TypeConversionDirection.FROM_DAFNY);
    ...
    private String generateConstructorArg(final MemberShape memberShape) {
        if (nameResolver.memberShapeIsOptional(memberShape)) {
            return "%s(%s)".formatted(
                    DotNetNameResolver.typeConverterForShape(memberShape.getId(), TypeConversionDirection.TO_DAFNY),
    ...
    public TypeConverter generateMemberConverter(final MemberShape memberShape) {
        ...
        final String targetFromDafnyConverterName = DotNetNameResolver.typeConverterForShape(targetShape.getId(), TypeConversionDirection.FROM_DAFNY);
        final String targetToDafnyConverterName = DotNetNameResolver.typeConverterForShape(targetShape.getId(), TypeConversionDirection.TO_DAFNY);
    ...
    public TypeConverter generateUnionConverter(final UnionShape unionShape) {
        ...
        final TokenTree toDafnyBody = TokenTree
                .of(defNames.stream().map(memberShape -> {
                    ...
                    final String memberFromDafnyConverterName = DotNetNameResolver.typeConverterForShape(
                            memberShape.getId(), TypeConversionDirection.TO_DAFNY);
    ...
    private TypeConverter generatePositionalStructureConverter(final StructureShape structureShape) {
        ...
        final String memberFromDafnyConverterName = DotNetNameResolver.typeConverterForShape(memberShapeId, TypeConversionDirection.FROM_DAFNY);
        final String memberToDafnyConverterName = DotNetNameResolver.typeConverterForShape(memberShapeId, TypeConversionDirection.TO_DAFNY);
    ...
    public TypeConverter generateCommonExceptionConverter() {
        ...
        final TokenTree modeledExceptionsFromDafny = TokenTree.of(errorShapes
          ...
          .map(errorShape -> {
            ...
            return Token.of("case %1$s dafnyVal:\nreturn %2$s(dafnyVal);".formatted(
                    ...
                    DotNetNameResolver.typeConverterForShape(modeledErrorShapeId, TypeConversionDirection.FROM_DAFNY)
            ));
        })).lineSeparated();
          ...
          .of(
            ...
            "return new %1$s(new System.Collections.Generic.List<Exception>(dafnyVal._list.Elements.Select(x => %2$s(x))));"
              .formatted(DotNetNameResolver.baseClassForCollectionOfErrors(),
                nameResolver.qualifiedTypeConverterForCommonError(serviceShape, TypeConversionDirection.FROM_DAFNY))
          ).lineSeparated();
        ...
        final TokenTree fromDafnyConverterSignature = Token.of("public static %s %s(%s value)"
          .formatted(
            cSharpType,
            nameResolver.typeConverterForCommonError(serviceShape, TypeConversionDirection.FROM_DAFNY),
            dafnyType
          ));
        ...
        final TokenTree specificExceptionsToDafny = TokenTree.of(errorShapes.stream().map(errorShape -> {
            ...
            return Token.of("case %1$s exception:\n return %2$s(exception);".formatted(
                    ...
                    DotNetNameResolver.typeConverterForShape(specificErrorShapeId, TypeConversionDirection.TO_DAFNY)
            ));
        })).lineSeparated();
        ...
        final TokenTree handleCollectionOfErrorsToDafny = TokenTree
            .of("""
                ...
                .formatted(DotNetNameResolver.baseClassForCollectionOfErrors(),
                    ...
                    nameResolver.qualifiedTypeConverterForCommonError(serviceShape, TypeConversionDirection.TO_DAFNY))
            )
            .lineSeparated();
        ...
        final TokenTree toDafnyConverterSignature = Token.of("public static %s %s(System.Exception value)".formatted(
                dafnyType, nameResolver.typeConverterForCommonError(serviceShape, TypeConversionDirection.TO_DAFNY)));
    ...
    public TypeConverter generateSpecificExceptionConverter(final StructureShape errorShape) {
        ...
        final Token fromDafnyBody = Token.of("return new %s(%s(value.message));".formatted(
                ...
                DotNetNameResolver.typeConverterForShape(messageShapeId, TypeConversionDirection.FROM_DAFNY)
        ));
        final Token toDafnyBody = Token.of("""
                ...
                """.formatted(
                        ...
                        DotNetNameResolver.typeConverterForShape(messageShapeId, TypeConversionDirection.TO_DAFNY)
        ));
    ...
    protected TypeConverter buildConverterFromMethodBodies(
        ...
        final String fromDafnyConverterName = DotNetNameResolver.typeConverterForShape(id, TypeConversionDirection.FROM_DAFNY);
        ...
        final String toDafnyConverterName = DotNetNameResolver.typeConverterForShape(id, TypeConversionDirection.TO_DAFNY);
