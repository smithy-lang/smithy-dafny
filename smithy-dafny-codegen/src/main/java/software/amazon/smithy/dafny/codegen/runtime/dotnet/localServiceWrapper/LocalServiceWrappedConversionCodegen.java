    ...
    protected TypeConverter buildConverterFromMethodBodies(
      ...
      final TokenTree toDafnyBody
        ...
        if (!shouldWrapLocalResource) {
            ...
            final String fromDafnyConverterName = DotNetNameResolver.typeConverterForShape(shape.getId(), TypeConversionDirection.FROM_DAFNY);
            ...
            final String toDafnyConverterName = DotNetNameResolver.typeConverterForShape(shape.getId(), TypeConversionDirection.TO_DAFNY);
