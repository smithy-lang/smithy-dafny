...
package software.amazon.smithy.dafny.codegen.runtime.dotnet.nativeWrapper;
...
public class NativeWrapperCodegen {
    ...
    TokenTree generateOperationWrapper(final ShapeId operationShapeId) {
        ...
        final TokenTree body_k = TokenTree
                .of("throw new %s(\"Not supported at this time.\");"
                        .formatted(DotNetNameResolver.classForConcreteServiceException(serviceShape)))
                .braced();
    ...
    TokenTree generateInputConversion(Optional<ShapeId> inputShapeId) {
        ...
        return TokenTree.of("%s %s = %s(%s);".formatted(
                ...
                NATIVE_INPUT,
                DotNetNameResolver.qualifiedTypeConverter(inputShapeId.get(), TypeConversionDirection.FROM_DAFNY),
                INPUT));
    }
    ...
    TokenTree generateIsNativeOutputNull(
        ...
        final String exception = DotNetNameResolver.classForConcreteServiceException(serviceShape);
