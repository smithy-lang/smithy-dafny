...
import static software.amazon.smithy.dafny.codegen.runtime.java.nameresolver.Constants.SHAPE_TYPES_LIST_SET_MAP;
...
public class AwsSdkNativeV2 extends Native {
    ...
    public CodeBlock fieldForSetMember(MemberShape shape) {
        ...
        String tokenToUncapitalize = AwsSdkV2NameResolverUtils.tokenToUncapitalizeInShape(shape);
        ...
        if (shape.getContainer().getName().equals("AttributeValue")
            && AwsSdkV2NameResolverUtils.isAttributeValueType(shape)) {
