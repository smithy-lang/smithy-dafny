...
package software.amazon.smithy.polymorph.traits;
 ...
 */
public class ExtendableTrait extends AbstractTrait implements ToSmithyBuilder<ExtendableTrait> {
    public static final ShapeId ID = ShapeId.from("aws.polymorph#extendable");

    private ExtendableTrait(Builder builder) { super(ID, builder.getSourceLocation()); }
    ...
    public static final class Builder extends AbstractTraitBuilder<ExtendableTrait, Builder> {

        private Builder() {}

        @Override
        public ExtendableTrait build() { return new ExtendableTrait(this); }
    }
