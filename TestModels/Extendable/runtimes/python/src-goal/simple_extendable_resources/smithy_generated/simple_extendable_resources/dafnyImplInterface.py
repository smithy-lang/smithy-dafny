...
from simple.extendable.resources.internaldafny.impl import SimpleExtendableResourcesClient
from .dafny_protocol import DafnyRequest

class DafnyImplInterface:
    impl: SimpleExtendableResourcesClient | None = None
    ...
    def handle_request(self, input: DafnyRequest):
        if self.operation_map is None:
            self.operation_map = {
                "CreateExtendableResource": self.impl.CreateExtendableResource,
                "UseExtendableResource": self.impl.UseExtendableResource,
                "UseExtendableResourceAlwaysModeledError": self.impl.UseExtendableResourceAlwaysModeledError,
                "UseExtendableResourceAlwaysMultipleErrors": self.impl.UseExtendableResourceAlwaysMultipleErrors,
                "UseExtendableResourceAlwaysOpaqueError": self.impl.UseExtendableResourceAlwaysOpaqueError,
            }
