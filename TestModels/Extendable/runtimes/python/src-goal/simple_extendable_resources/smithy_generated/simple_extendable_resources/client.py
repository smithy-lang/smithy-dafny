...
from .deserialize import (
    _deserialize_always_modeled_error,
    _deserialize_always_multiple_errors,
    _deserialize_always_opaque_error,
    _deserialize_create_extendable_resource,
    _deserialize_get_extendable_resource_data,
    _deserialize_use_extendable_resource,
    _deserialize_use_extendable_resource_always_modeled_error,
    _deserialize_use_extendable_resource_always_multiple_errors,
    _deserialize_use_extendable_resource_always_opaque_error,
)
...
from .serialize import (
    _serialize_always_modeled_error,
    _serialize_always_multiple_errors,
    _serialize_always_opaque_error,
    _serialize_create_extendable_resource,
    _serialize_get_extendable_resource_data,
    _serialize_use_extendable_resource,
    _serialize_use_extendable_resource_always_modeled_error,
    _serialize_use_extendable_resource_always_multiple_errors,
    _serialize_use_extendable_resource_always_opaque_error,
)
...
class SimpleExtendableResources:
    """Client for SimpleExtendableResources
    ...
    async def always_modeled_error(self, input: GetExtendableResourceErrorsInput, plugins: list[Plugin] | None = None) -> GetExtendableResourceErrorsOutput:
        """Invokes the AlwaysModeledError operation.
        ...
        return await self._execute_operation(
            ...
            serialize=_serialize_always_modeled_error,
            deserialize=_deserialize_always_modeled_error,
            config=self._config,
        )

    async def always_multiple_errors(self, input: GetExtendableResourceErrorsInput, plugins: list[Plugin] | None = None) -> GetExtendableResourceErrorsOutput:
        """Invokes the AlwaysMultipleErrors operation.
        ...
        return await self._execute_operation(
            input=input,
            plugins=operation_plugins,
            serialize=_serialize_always_multiple_errors,
            deserialize=_deserialize_always_multiple_errors,
            config=self._config,
        )

    async def always_opaque_error(self, input: GetExtendableResourceErrorsInput, plugins: list[Plugin] | None = None) -> GetExtendableResourceErrorsOutput:
        """Invokes the AlwaysOpaqueError operation.
        ...
        return await self._execute_operation(
            input=input,
            plugins=operation_plugins,
            serialize=_serialize_always_opaque_error,
            deserialize=_deserialize_always_opaque_error,
            config=self._config,
        )

    async def create_extendable_resource(self, input: CreateExtendableResourceInput, plugins: list[Plugin] | None = None) -> CreateExtendableResourceOutput:
        """Invokes the CreateExtendableResource operation.
        ...
        return await self._execute_operation(
            input=input,
            plugins=operation_plugins,
            serialize=_serialize_create_extendable_resource,
            deserialize=_deserialize_create_extendable_resource,
            config=self._config,
        )

    async def get_extendable_resource_data(self, input: GetExtendableResourceDataInput, plugins: list[Plugin] | None = None) -> GetExtendableResourceDataOutput:
        """Invokes the GetExtendableResourceData operation.
        ...
        return await self._execute_operation(
            input=input,
            plugins=operation_plugins,
            serialize=_serialize_get_extendable_resource_data,
            deserialize=_deserialize_get_extendable_resource_data,
            config=self._config,
        )

    async def use_extendable_resource(self, input: UseExtendableResourceInput, plugins: list[Plugin] | None = None) -> UseExtendableResourceOutput:
        """Invokes the UseExtendableResource operation.
        ...
        return await self._execute_operation(
            input=input,
            plugins=operation_plugins,
            serialize=_serialize_use_extendable_resource,
            deserialize=_deserialize_use_extendable_resource,
            config=self._config,
        )

    async def use_extendable_resource_always_modeled_error(self, input: UseExtendableResourceErrorsInput, plugins: list[Plugin] | None = None) -> GetExtendableResourceErrorsOutput:
        """Invokes the UseExtendableResourceAlwaysModeledError operation.
        ...
        return await self._execute_operation(
            input=input,
            plugins=operation_plugins,
            serialize=_serialize_use_extendable_resource_always_modeled_error,
            deserialize=_deserialize_use_extendable_resource_always_modeled_error,
            config=self._config,
        )

    async def use_extendable_resource_always_multiple_errors(self, input: UseExtendableResourceErrorsInput, plugins: list[Plugin] | None = None) -> GetExtendableResourceErrorsOutput:
        """Invokes the UseExtendableResourceAlwaysMultipleErrors operation.
        ...
        return await self._execute_operation(
            input=input,
            plugins=operation_plugins,
            serialize=_serialize_use_extendable_resource_always_multiple_errors,
            deserialize=_deserialize_use_extendable_resource_always_multiple_errors,
            config=self._config,
        )

    async def use_extendable_resource_always_opaque_error(self, input: UseExtendableResourceErrorsInput, plugins: list[Plugin] | None = None) -> GetExtendableResourceErrorsOutput:
        """Invokes the UseExtendableResourceAlwaysOpaqueError operation.
        ...
        return await self._execute_operation(
            input=input,
            plugins=operation_plugins,
            serialize=_serialize_use_extendable_resource_always_opaque_error,
            deserialize=_deserialize_use_extendable_resource_always_opaque_error,
            config=self._config,
        )
