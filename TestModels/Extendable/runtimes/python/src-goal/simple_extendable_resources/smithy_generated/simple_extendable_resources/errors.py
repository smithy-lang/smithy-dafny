...
class SimpleExtendableResourcesException(ApiError[Literal["SimpleExtendableResourcesException"]]):
    code: Literal["SimpleExtendableResourcesException"] = "SimpleExtendableResourcesException"
    message: str
