...
>{
    ...
    resource: ::dafny_runtime::Object (Some(inner) )
  })
}
...
pub fn from_dafny(
    ...
    let wrap = ExtendableResourceDafnyWrapper {
        obj: dafny_value.resource().clone(),
    };
    crate::operation::create_extendable_resource::CreateExtendableResourceOutput {
    ...
    for ExtendableResourceWrapper
{
    ...
    fn _AlwaysMultipleErrors_k(&mut self, _: & std::rc::Rc<simple_extendable_dafny::_simple_dextendable_dresources_dinternaldafny_dtypes::GetExtendableResourceErrorsInput>)
    ...
    { todo!() }
    fn _AlwaysModeledError_k(&mut self, _: & std::rc::Rc<simple_extendable_dafny::_simple_dextendable_dresources_dinternaldafny_dtypes::GetExtendableResourceErrorsInput>)
    ->  std::rc::Rc<simple_extendable_dafny::_Wrappers_Compile::Result< std::rc::Rc<simple_extendable_dafny::_simple_dextendable_dresources_dinternaldafny_dtypes::GetExtendableResourceErrorsOutput>,  std::rc::Rc<simple_extendable_dafny::_simple_dextendable_dresources_dinternaldafny_dtypes::Error>>>
    { todo!() }
    fn _AlwaysOpaqueError_k(&mut self, _: & std::rc::Rc<simple_extendable_dafny::_simple_dextendable_dresources_dinternaldafny_dtypes::GetExtendableResourceErrorsInput>)
    ->  std::rc::Rc<simple_extendable_dafny::_Wrappers_Compile::Result< std::rc::Rc<simple_extendable_dafny::_simple_dextendable_dresources_dinternaldafny_dtypes::GetExtendableResourceErrorsOutput>,  std::rc::Rc<simple_extendable_dafny::_simple_dextendable_dresources_dinternaldafny_dtypes::Error>>>
    { todo!() }
 }
