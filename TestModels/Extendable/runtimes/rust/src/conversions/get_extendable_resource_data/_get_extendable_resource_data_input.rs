...
>{
    ::std::rc::Rc::new(crate::r#simple::extendable::resources::internaldafny::types::GetExtendableResourceDataInput::GetExtendableResourceDataInput {
...
pub fn from_dafny(
    ...
    match &*dafny_value {
        crate::r#simple::extendable::resources::internaldafny::types::GetExtendableResourceDataInput::GetExtendableResourceDataInput {
            blobValue,
            booleanValue,
            integerValue,
            longValue,
