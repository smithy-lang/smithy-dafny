...
impl AlwaysError {
    ...
    pub(crate) async fn send(
        ...
        input: crate::operation::always_error::GetErrorsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        if matches!(
            ...
            Ok(
                crate::conversions::always_error::_always_error_output::from_dafny(inner_result.value().clone()),
            )
        } else {
...
pub use crate::operation::always_error::_get_errors_output::GetErrorsOutput;

pub use crate::operation::always_error::_get_errors_input::GetErrorsInput;
