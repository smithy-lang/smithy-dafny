...
pub use crate::operation::always_native_error::_get_errors_output::GetErrorsOutputBuilder;

pub use crate::operation::always_native_error::_get_errors_input::GetErrorsInputBuilder;
...
pub struct AlwaysNativeErrorFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::always_native_error::builders::GetErrorsInputBuilder,
}
impl AlwaysNativeErrorFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::always_native_error::builders::GetErrorsInputBuilder {
        &self.inner
    }
