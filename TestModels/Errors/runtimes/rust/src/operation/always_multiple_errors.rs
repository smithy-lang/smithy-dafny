...
impl AlwaysMultipleErrors {
    ...
    > {
        ...
        if matches!(
            ...
            Err(
                crate::conversions::always_multiple_errors::from_dafny_error(
...
/// Error type for the `AlwaysMultipleErrors` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum AlwaysMultipleErrorsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AlwaysMultipleErrorsError) for what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl AlwaysMultipleErrorsError {
    /// Creates the `AlwaysMultipleErrorsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `AlwaysMultipleErrorsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for AlwaysMultipleErrorsError {
...
impl ::std::fmt::Display for AlwaysMultipleErrorsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for AlwaysMultipleErrorsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AlwaysMultipleErrorsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AlwaysMultipleErrorsError {
