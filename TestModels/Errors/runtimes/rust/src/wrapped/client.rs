...
impl crate::r#simple::errors::internaldafny::types::ISimpleErrorsClient for Client {
    ...
    >{
        let inner_input =
            crate::conversions::always_error::_always_error_input::from_dafny(input.clone());
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::always_error::_always_error_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::always_multiple_errors::_always_multiple_errors_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::always_multiple_errors::_always_multiple_errors_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::always_native_error::_always_native_error_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::always_native_error::_always_native_error_output::to_dafny(client),
                },
            ),
        }
    }
