    ...
    ::std::rc::Rc<crate::r#simple::errors::internaldafny::types::Error>
{
    ...
    ::std::rc::Rc::new(
        crate::r#simple::errors::internaldafny::types::Error::Opaque {
            obj: error_obj,
        },
    )
}
...
pub fn to_dafny(
    ...
    crate::r#simple::errors::internaldafny::types::Error::SimpleErrorsException {
        ...
        crate::types::error::Error::CollectionOfErrors { list, message } =>
            crate::r#simple::errors::internaldafny::types::Error::CollectionOfErrors {
                message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::string_to_dafny_string(&message),
...
pub fn from_dafny(
    ...
    crate::types::error::Error::SimpleErrorsException {
