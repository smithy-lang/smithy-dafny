...
//     match value {
//     crate::operation::always_multiple_errors::AlwaysMultipleErrorsError::Unhandled(unhandled) =>
...
//     crate::operation::always_multiple_errors::AlwaysMultipleErrorsError::generic(::aws_smithy_types::error::metadata::ErrorMetadata::builder().message(error_message).build())
//   } else {
//     crate::operation::always_multiple_errors::AlwaysMultipleErrorsError::generic(::aws_smithy_types::error::metadata::ErrorMetadata::builder().message("Opaque error").build())
//   }
// }
