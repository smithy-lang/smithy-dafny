...
//     match value {
//     crate::operation::always_native_error::AlwaysNativeErrorError::Unhandled(unhandled) =>
...
//     crate::operation::always_native_error::AlwaysNativeErrorError::generic(::aws_smithy_types::error::metadata::ErrorMetadata::builder().message(error_message).build())
//   } else {
//     crate::operation::always_native_error::AlwaysNativeErrorError::generic(::aws_smithy_types::error::metadata::ErrorMetadata::builder().message("Opaque error").build())
//   }
// }
