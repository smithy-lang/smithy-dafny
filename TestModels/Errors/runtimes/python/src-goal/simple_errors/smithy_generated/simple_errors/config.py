...
_ServiceInterceptor = Union[Interceptor[GetErrorsInput, GetErrorsOutput, Any, Any], Interceptor[GetErrorsInput, GetErrorsOutput, Any, Any], Interceptor[GetErrorsInput, GetErrorsOutput, Any, Any]]
@dataclass(kw_only=True)
class Config:
    """Configuration for SimpleErrors
