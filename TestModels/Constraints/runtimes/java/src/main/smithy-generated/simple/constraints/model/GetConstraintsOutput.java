...
public class GetConstraintsOutput {
  ...
  private final long thatTenToTen;
  ...
  protected GetConstraintsOutput(BuilderImpl builder) {
    ...
    this.thatTenToTen = builder.thatTenToTen();
  ...
  public long thatTenToTen() {
    return this.thatTenToTen;
  }
  ...
  public interface Builder {
    ...
    Builder thatTenToTen(long thatTenToTen);
  ...
  static class BuilderImpl implements Builder {
    ...
    protected long thatTenToTen;

    private boolean _thatTenToTenSet = false;
    ...
    protected BuilderImpl(GetConstraintsOutput model) {
      ...
      this.thatTenToTen = model.thatTenToTen();
      this._thatTenToTenSet = true;
    ...
    public Builder thatTenToTen(long thatTenToTen) {
      this.thatTenToTen = thatTenToTen;
      this._thatTenToTenSet = true;
      return this;
    }
    ...
    public GetConstraintsOutput build() {
      ...
      if (this._thatTenToTenSet && this.thatTenToTen() < -10) {
        throw new IllegalArgumentException(
          "`thatTenToTen` must be greater than or equal to -10"
        );
      }
      if (this._thatTenToTenSet && this.thatTenToTen() > 10) {
        throw new IllegalArgumentException(
          "`thatTenToTen` must be less than or equal to 10."
        );
      }
      ...
      return new GetConstraintsOutput(this);
    }
  }
}
