...
public class SimpleConstraintsException extends RuntimeException {

  protected SimpleConstraintsException(BuilderImpl builder) {
  ...
  public interface Builder {
    ...
    SimpleConstraintsException build();
  }
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(SimpleConstraintsException model) {
    ...
    public SimpleConstraintsException build() {
      if (Objects.isNull(this.message())) {
        throw new IllegalArgumentException(
          "Missing value for required field `message`"
        );
      }
      return new SimpleConstraintsException(this);
    }
  }
}
