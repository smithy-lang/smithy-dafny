...
public class GetConstraintsOutput {
  ...
  public String toString() {
    ...
    s.append("Dafny.Simple.Constraints.Types_Compile.GetConstraintsOutput.GetConstraintsOutput");
    s.append("(");
  ...
  private static final GetConstraintsOutput theDefault = Dafny.Simple.Constraints.Types.GetConstraintsOutput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Byte>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Byte>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Byte>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>>Default(), Wrappers_Compile.Option.<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends dafny.DafnySequence<? extends Character>>>Default(), Wrappers_Compile.Option.<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends dafny.DafnySequence<? extends Character>>>Default(), Wrappers_Compile.Option.<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends dafny.DafnySequence<? extends Character>>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(), Wrappers_Compile.Option.<Integer>Default(), Wrappers_Compile.Option.<Integer>Default(), Wrappers_Compile.Option.<Integer>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends ComplexListElement>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Byte>>Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Byte>>>Default());
  public static GetConstraintsOutput Default() {
    return theDefault;
  }
  private static final dafny.TypeDescriptor<GetConstraintsOutput> _TYPE = dafny.TypeDescriptor.referenceWithInitializer(GetConstraintsOutput.class, () -> Default());
