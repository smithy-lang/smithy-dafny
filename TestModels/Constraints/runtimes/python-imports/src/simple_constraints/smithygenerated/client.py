...
from .deserialize import _deserialize_get_constraints
from .errors import ServiceError
from .models import GetConstraintsInput, GetConstraintsOutput
from .serialize import _serialize_get_constraints
...
class SimpleConstraints:
    ...
    async def get_constraints(self, input: GetConstraintsInput, plugins: list[Plugin] | None = None) -> GetConstraintsOutput:
        """Invokes the GetConstraints operation.
        ...
        return await self._execute_operation(
            ...
            serialize=_serialize_get_constraints,
            deserialize=_deserialize_get_constraints,
            config=self._config,
            operation_name="GetConstraints",
        )
