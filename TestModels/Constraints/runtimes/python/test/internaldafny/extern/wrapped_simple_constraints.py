...
from simple_constraints.smithygenerated.simple_constraints.shim import ConstraintsShim
...
class default__(WrappedSimpleConstraintsService.default__):
    ...
    @staticmethod
    def WrappedConstraints(config):
        wrapped_config = dafny_config_to_smithy_config(config)
        impl = SimpleConstraints(wrapped_config)
        wrapped_client = ConstraintsShim(impl)
