...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::get_constraints::GetConstraintsInput,
) -> ::std::rc::Rc<
    crate::r#simple::constraints::internaldafny::types::GetConstraintsInput,
>{
    ::std::rc::Rc::new(crate::r#simple::constraints::internaldafny::types::GetConstraintsInput::GetConstraintsInput {
...
,
 ...
 myTenToTen: crate::standard_library_conversions::olong_to_dafny(&value.my_ten_to_ten),
...
pub fn from_dafny(
    ...
    crate::operation::get_constraints::GetConstraintsInput::builder()
 ...
 .set_my_ten_to_ten(crate::standard_library_conversions::olong_from_dafny(dafny_value.myTenToTen().clone()))
