...
pub struct GetConstraintsInput {
    #[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub my_ten_to_ten: ::std::option::Option<::std::primitive::i64>,
}
impl GetConstraintsInput {
    #[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn my_ten_to_ten(&self) -> &::std::option::Option<::std::primitive::i64> {
    &self.my_ten_to_ten
}
}
impl GetConstraintsInput {
    /// Creates a new builder-style object to manufacture [`GetConstraintsInput`](crate::operation::get_constraints::builders::GetConstraintsInput).
    pub fn builder() -> crate::operation::get_constraints::builders::GetConstraintsInputBuilder {
        crate::operation::get_constraints::builders::GetConstraintsInputBuilder::default()
    }
}

/// A builder for [`GetConstraintsInput`](crate::operation::operation::GetConstraintsInput).
#[non_exhaustive]
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug,
)]
pub struct GetConstraintsInputBuilder {
...
pub(crate) my_ten_to_ten: ::std::option::Option<::std::primitive::i64>,
}
...
pub fn get_my_ten_to_ten(&self) -> &::std::option::Option<::std::primitive::i64> {
    ...
    /// Consumes the builder and constructs a [`GetConstraintsInput`](crate::operation::operation::GetConstraintsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
...
my_ten_to_ten: self.my_ten_to_ten,
        })
    }
}
