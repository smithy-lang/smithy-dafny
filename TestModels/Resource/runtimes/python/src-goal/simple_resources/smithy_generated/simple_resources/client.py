...
from .deserialize import _deserialize_get_resources
from .errors import ServiceError
from .models import GetResourcesInput, GetResourcesOutput
from .serialize import _serialize_get_resources
...
class SimpleResources:
    ...
    async def get_resources(self, input: GetResourcesInput, plugins: list[Plugin] | None = None) -> GetResourcesOutput:
        """Invokes the GetResources operation.
        ...
        return await self._execute_operation(
            ...
            serialize=_serialize_get_resources,
            deserialize=_deserialize_get_resources,
            config=self._config,
        )
