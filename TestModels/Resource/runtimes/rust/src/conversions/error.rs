    ...
    ::std::rc::Rc<crate::r#simple::resources::internaldafny::types::Error>
{
    ...
    ::std::rc::Rc::new(
        crate::r#simple::resources::internaldafny::types::Error::Opaque {
            obj: error_obj,
        },
    )
}
...
pub fn to_dafny(
    ...
    ::std::rc::Rc::new(match value {
        crate::types::error::Error::SimpleResourcesException { message } =>
    crate::r#simple::resources::internaldafny::types::Error::SimpleResourcesException {
        ...
        crate::types::error::Error::CollectionOfErrors { list, message } =>
            crate::r#simple::resources::internaldafny::types::Error::CollectionOfErrors {
                message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::string_to_dafny_string(&message),
...
pub fn from_dafny(
    ...
    match ::std::borrow::Borrow::borrow(&dafny_value) {
        crate::r#simple::resources::internaldafny::types::Error::SimpleResourcesException { message } =>
    crate::types::error::Error::SimpleResourcesException {
        message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(&message),
    },
        crate::r#simple::resources::internaldafny::types::Error::CollectionOfErrors { list, message } =>
        ...
        crate::r#simple::resources::internaldafny::types::Error::Opaque { obj } =>
