...
impl crate::r#simple::resources::internaldafny::types::ISimpleResourcesClient for Client {
    ...
    >{
        let inner_input =
            crate::conversions::get_resources::_get_resources_input::from_dafny(input.clone());
        ...
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Failure {
                    error: crate::conversions::get_resources::to_dafny_error(error),
                },
            ),
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::get_resources::_get_resources_output::to_dafny(client),
                },
            ),
        }
    }
