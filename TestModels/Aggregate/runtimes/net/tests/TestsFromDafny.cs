...
// Command Line Options: -vcsCores:2 -compileTarget:cs -spillTargetCode:3 -runAllTests:1 -compile:0 -optimizeErasableDatatypeWrapper:0 -useRuntimeLib -out runtimes/net/tests/TestsFromDafny ./test/WrappedSimpleAggregateImplTest.dfy ./test/SimpleAggregateImplTest.dfy ./test/WrappedSimpleAggregateImpl.dfy -library:src/Index.dfy
// the_program
...
module WrappedSimpleTypesStringTest {
  ...
  {
    var client :- WrappedSimpleAggregateService.WrappedSimpleAggregate();
...
module SimpleAggregateImplTest {
  ...
  method {:test} GetAggregate()
  {
    var client :- SimpleAggregate.SimpleAggregate();
...
module {:extern ""Dafny.Simple.Aggregate.Wrapped""} WrappedSimpleAggregateService refines WrappedAbstractSimpleAggregateService {
  ...
  method {:extern} WrappedSimpleAggregate(config: SimpleAggregateConfig := WrappedDefaultSimpleAggregateConfig()) returns (res: Result<ISimpleAggregateClient, Error>)
...
namespace Dafny.Simple.Aggregate.Wrapped {

  public partial class __default {
    public static Dafny.Simple.Aggregate.Types._ISimpleAggregateConfig WrappedDefaultSimpleAggregateConfig() {
      return Dafny.Simple.Aggregate.Types.SimpleAggregateConfig.create();
    }
  }
} // end of namespace Dafny.Simple.Aggregate.Wrapped
namespace SimpleAggregateImplTest_Compile {

  public partial class __default {
    public static void GetAggregate()
    {
      Dafny.Simple.Aggregate.SimpleAggregateClient _0_client;
      Wrappers_Compile._IResult<Dafny.Simple.Aggregate.SimpleAggregateClient, Dafny.Simple.Aggregate.Types._IError> _1_valueOrError0 = default(Wrappers_Compile._IResult<Dafny.Simple.Aggregate.SimpleAggregateClient, Dafny.Simple.Aggregate.Types._IError>);
      Wrappers_Compile._IResult<Dafny.Simple.Aggregate.SimpleAggregateClient, Dafny.Simple.Aggregate.Types._IError> _out0;
      _out0 = Dafny.Simple.Aggregate.__default.SimpleAggregate(Dafny.Simple.Aggregate.__default.DefaultSimpleAggregateConfig());
      _1_valueOrError0 = _out0;
      if (!(!((_1_valueOrError0).IsFailure()))) {
        throw new Dafny.HaltException("/Users/scchatur/workspace/polymorph/TestModels/Aggregate/test/SimpleAggregateImplTest.dfy(8,19): " + _1_valueOrError0);
      }
      _0_client = (_1_valueOrError0).Extract();
      SimpleAggregateImplTest_Compile.__default.TestGetAggregate(_0_client);
    }
    public static void TestGetAggregate(Dafny.Simple.Aggregate.Types.ISimpleAggregateClient client)
    {
      Dafny.ISequence<Dafny.ISequence<char>> _2_stringList;
      _2_stringList = Dafny.Sequence<Dafny.ISequence<char>>.FromElements(Dafny.Sequence<char>.FromString("Test"));
      Dafny.IMap<Dafny.ISequence<char>,Dafny.ISequence<char>> _3_simpleStringMap;
      _3_simpleStringMap = Dafny.Map<Dafny.ISequence<char>, Dafny.ISequence<char>>.FromElements(new Dafny.Pair<Dafny.ISequence<char>, Dafny.ISequence<char>>(Dafny.Sequence<char>.FromString("Test1"), Dafny.Sequence<char>.FromString("Success")));
      Dafny.ISequence<Dafny.Simple.Aggregate.Types._IStructureListElement> _4_structureList;
      _4_structureList = Dafny.Sequence<Dafny.Simple.Aggregate.Types._IStructureListElement>.FromElements(Dafny.Simple.Aggregate.Types.StructureListElement.create(Wrappers_Compile.Option<Dafny.ISequence<char>>.create_Some(Dafny.Sequence<char>.FromString("Test2")), Wrappers_Compile.Option<int>.create_Some(2)));
      Dafny.IMap<Dafny.ISequence<char>,int> _5_simpleIntegerMap;
      _5_simpleIntegerMap = Dafny.Map<Dafny.ISequence<char>, int>.FromElements(new Dafny.Pair<Dafny.ISequence<char>, int>(Dafny.Sequence<char>.FromString("Test3"), 3));
      Dafny.Simple.Aggregate.Types._IDeeply _6_nested;
      _6_nested = Dafny.Simple.Aggregate.Types.Deeply.create(Wrappers_Compile.Option<Dafny.Simple.Aggregate.Types._INested>.create_Some(Dafny.Simple.Aggregate.Types.Nested.create(Wrappers_Compile.Option<Dafny.ISequence<char>>.create_Some(Dafny.Sequence<char>.FromString("Nest")))));
      Wrappers_Compile._IResult<Dafny.Simple.Aggregate.Types._IGetAggregateOutput, Dafny.Simple.Aggregate.Types._IError> _7_ret;
      Wrappers_Compile._IResult<Dafny.Simple.Aggregate.Types._IGetAggregateOutput, Dafny.Simple.Aggregate.Types._IError> _out1;
      _out1 = (client).GetAggregate(Dafny.Simple.Aggregate.Types.GetAggregateInput.create(Wrappers_Compile.Option<Dafny.ISequence<Dafny.ISequence<char>>>.create_Some(_2_stringList), Wrappers_Compile.Option<Dafny.ISequence<Dafny.Simple.Aggregate.Types._IStructureListElement>>.create_Some(_4_structureList), Wrappers_Compile.Option<Dafny.IMap<Dafny.ISequence<char>,Dafny.ISequence<char>>>.create_Some(_3_simpleStringMap), Wrappers_Compile.Option<Dafny.IMap<Dafny.ISequence<char>,int>>.create_Some(_5_simpleIntegerMap), Wrappers_Compile.Option<Dafny.Simple.Aggregate.Types._IDeeply>.create_Some(_6_nested)));
      _7_ret = _out1;
      if (!((_7_ret).is_Success)) {
        throw new Dafny.HaltException("/Users/scchatur/workspace/polymorph/TestModels/Aggregate/test/SimpleAggregateImplTest.dfy(23,8): " + Dafny.Sequence<char>.FromString("expectation violation"));
      }
      Dafny.Helpers.Print((_7_ret));
    }
  }
} // end of namespace SimpleAggregateImplTest_Compile
namespace WrappedSimpleTypesStringTest_Compile {

  public partial class __default {
    public static void GetAggregate()
    {
      Dafny.Simple.Aggregate.Types.ISimpleAggregateClient _8_client;
      Wrappers_Compile._IResult<Dafny.Simple.Aggregate.Types.ISimpleAggregateClient, Dafny.Simple.Aggregate.Types._IError> _9_valueOrError0 = default(Wrappers_Compile._IResult<Dafny.Simple.Aggregate.Types.ISimpleAggregateClient, Dafny.Simple.Aggregate.Types._IError>);
      Wrappers_Compile._IResult<Dafny.Simple.Aggregate.Types.ISimpleAggregateClient, Dafny.Simple.Aggregate.Types._IError> _out2;
      _out2 = Dafny.Simple.Aggregate.Wrapped.__default.WrappedSimpleAggregate(Dafny.Simple.Aggregate.Wrapped.__default.WrappedDefaultSimpleAggregateConfig());
      _9_valueOrError0 = _out2;
      if (!(!((_9_valueOrError0).IsFailure()))) {
        throw new Dafny.HaltException("/Users/scchatur/workspace/polymorph/TestModels/Aggregate/test/WrappedSimpleAggregateImplTest.dfy(9,19): " + _9_valueOrError0);
      }
      _8_client = (_9_valueOrError0).Extract();
      SimpleAggregateImplTest_Compile.__default.TestGetAggregate(_8_client);
    }
  }
} // end of namespace WrappedSimpleTypesStringTest_Compile
namespace _module {
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> __noArgsParameter)
    {
      bool _10_success;
      _10_success = true;
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"SimpleAggregateImplTest.GetAggregate: ")));
      try {
        {
          SimpleAggregateImplTest_Compile.__default.GetAggregate();
          {
...
")));
        ...
        var _11_haltMessage = Dafny.Sequence<char>.FromString(e.Message);
        {
          Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"FAILED
	")));
          Dafny.Helpers.Print((_11_haltMessage));
          Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"
")));
          _10_success = false;
        }
      }
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"WrappedSimpleTypesStringTest.GetAggregate: ")));
      try {
        {
          WrappedSimpleTypesStringTest_Compile.__default.GetAggregate();
          {
            Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"PASSED
")));
          }
        ...
        var _12_haltMessage = Dafny.Sequence<char>.FromString(e.Message);
        {
          Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"FAILED
	")));
          Dafny.Helpers.Print((_12_haltMessage));
          Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"
")));
          _10_success = false;
        }
      ...
      if (!(_10_success)) {
        throw new Dafny.HaltException("/Users/scchatur/workspace/polymorph/TestModels/Aggregate/test/WrappedSimpleAggregateImplTest.dfy(8,18): " + Dafny.Sequence<char>.FromString(@"Test failures occurred: see above.
"));
      }
    }
  }
