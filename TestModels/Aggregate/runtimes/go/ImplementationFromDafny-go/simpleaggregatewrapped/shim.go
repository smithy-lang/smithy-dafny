...
package SimpleAggregatewrapped
...
type Shim struct {
	SimpleAggregate.ISimpleAggregateClient
	client *SimpleAggregate.Client
}

func WrappedSimpleAggregate(inputConfig SimpleAggregate.SimpleAggregateConfig_smithygenerated) Wrappers.Result {
	...
	if nativeError != nil {
		return Wrappers.Companion_Result_.Create_Failure_(SimpleAggregate.Companion_Error_.Create_Opaque_(nativeError))
	}
	return Wrappers.Companion_Result_.Create_Success_(&Shim{client: nativeClient})
}

func (shim *Shim) GetAggregate(input SimpleAggregate.GetAggregateInput_smithygenerated) Wrappers.Result {
...
func (shim *Shim) GetAggregateKnownValueTest(input SimpleAggregate.GetAggregateInput_smithygenerated) Wrappers.Result {
	var native_request = SimpleAggregate.GetAggregateInput_FromDafny(input)
