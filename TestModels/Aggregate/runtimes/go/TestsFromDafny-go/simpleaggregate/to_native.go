...
func GetAggregateInput_FromDafny(dafnyInput SimpleAggregate.GetAggregateInput_smithygenerated) SimpleAggregateTypes.GetAggregateInput {
	...
	return SimpleAggregateTypes.GetAggregateInput_smithygenerated{SimpleStringList: func() []string {
		...
		return fieldValue
	}(), StructureList: func() []SimpleAggregateTypes.StructureListElement {
		...
		for i := dafny.Iterate(dafnyInput.Dtor_structureList().UnwrapOr(nil).(dafny.Sequence)); ; {
			...
			fieldValue = append(fieldValue, SimpleAggregateTypes.StructureListElement_smithygenerated{StringValue: func() *string {
				var s string
				if val.(SimpleAggregate.StructureListElement_smithygenerated).Dtor_stringValue().UnwrapOr(nil) == nil {
					return nil
				}
				for i := dafny.Iterate(val.(SimpleAggregate.StructureListElement_smithygenerated).Dtor_stringValue().UnwrapOr(nil)); ; {
					val, ok := i()
					if !ok {
						return &[]string{s}[0]
					} else {
				...
				var b int32
				if val.(SimpleAggregate.StructureListElement_smithygenerated).Dtor_integerValue().UnwrapOr(nil) == nil {
					return nil
				}
				b = val.(SimpleAggregate.StructureListElement_smithygenerated).Dtor_integerValue().UnwrapOr(nil).(int32)
				return &b
			}()})
		}
		return fieldValue
		...
		var s string
		if dafnyInput.Dtor_nestedStructure().UnwrapOr(nil).(SimpleAggregate.NestedStructure_smithygenerated).Dtor_stringStructure().UnwrapOr(nil).(SimpleAggregate.StringStructure_smithygenerated).Dtor_value().UnwrapOr(nil) == nil {
			return nil
		}
		for i := dafny.Iterate(dafnyInput.Dtor_nestedStructure().UnwrapOr(nil).(SimpleAggregate.NestedStructure_smithygenerated).Dtor_stringStructure().UnwrapOr(nil).(SimpleAggregate.StringStructure_smithygenerated).Dtor_value().UnwrapOr(nil)); ; {
			val, ok := i()
			if !ok {
				return &[]string{s}[0]
			} else {
...
func GetAggregateOutput_FromDafny(dafnyOutput SimpleAggregate.GetAggregateOutput_smithygenerated) SimpleAggregateTypes.GetAggregateOutput {
	...
	return SimpleAggregateTypes.GetAggregateOutput_smithygenerated{SimpleStringList: func() []string {
		...
		var s string
		if dafnyOutput.Dtor_nestedStructure().UnwrapOr(nil).(SimpleAggregate.NestedStructure_smithygenerated).Dtor_stringStructure().UnwrapOr(nil).(SimpleAggregate.StringStructure_smithygenerated).Dtor_value().UnwrapOr(nil) == nil {
			return nil
		}
		for i := dafny.Iterate(dafnyOutput.Dtor_nestedStructure().UnwrapOr(nil).(SimpleAggregate.NestedStructure_smithygenerated).Dtor_stringStructure().UnwrapOr(nil).(SimpleAggregate.StringStructure_smithygenerated).Dtor_value().UnwrapOr(nil)); ; {
			val, ok := i()
			if !ok {
				return &[]string{s}[0]
			} else {
...
func CollectionOfErrors_Output_FromDafny(dafnyOutput SimpleAggregate.Error) SimpleAggregateTypes.CollectionOfErrors {
...
func OpaqueError_Output_FromDafny(dafnyOutput SimpleAggregate.Error) SimpleAggregateTypes.OpaqueError {
	return SimpleAggregateTypes.OpaqueError{
		ErrObject: dafnyOutput.Dtor_obj(),
	}
}

func Error_FromDafny(err SimpleAggregate.Error) error {
	// Service Errors
...
func SimpleAggregateConfig_FromDafny(dafnyOutput SimpleAggregate.SimpleAggregateConfig_smithygenerated) SimpleAggregateTypes.SimpleAggregateConfig {
