...
impl GetAggregateInput {
    /// Creates a new builder-style object to manufacture [`GetAggregateInput`](crate::operation::operation::GetAggregateInput).
    pub fn builder() -> crate::operation::get_aggregate_known_value_test::builders::GetAggregateInputBuilder {
        crate::operation::get_aggregate_known_value_test::builders::GetAggregateInputBuilder::default()
    }
}

/// A builder for [`GetAggregateInput`](crate::operation::operation::GetAggregateInput).
#[non_exhaustive]
#[derive(
...
pub fn get_structure_list(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::StructureListElement>> {
    ...
    /// Consumes the builder and constructs a [`GetAggregateInput`](crate::operation::operation::GetAggregateInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_aggregate_known_value_test::GetAggregateInput {
