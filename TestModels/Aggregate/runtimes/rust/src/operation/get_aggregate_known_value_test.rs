...
impl GetAggregateKnownValueTest {
    ...
    pub(crate) async fn send(
        ...
        input: crate::operation::get_aggregate_known_value_test::GetAggregateInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        let inner_result =
            ::dafny_runtime::md!(client.dafny_client.clone()).GetAggregateKnownValueTest(&inner_input);
        if matches!(
            inner_result.as_ref(),
            ...
            Err(crate::conversions::get_aggregate_known_value_test::from_dafny_error(
...
/// Error type for the `GetAggregateKnownValueTest` operation.
#[non_exhaustive]
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetAggregateKnownValueTestError {
...
pub use crate::operation::get_aggregate_known_value_test::_get_aggregate_output::GetAggregateOutput;

pub use crate::operation::get_aggregate_known_value_test::_get_aggregate_input::GetAggregateInput;

pub(crate) mod _get_aggregate_output;

pub(crate) mod _get_aggregate_input;
