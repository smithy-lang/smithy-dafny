...
pub fn to_dafny(
    ...
    crate::implementation_from_dafny::r#_simple_daggregate_dinternaldafny_dtypes::GetAggregateInput,
> {
    ::std::rc::Rc::new(crate::implementation_from_dafny::r#_simple_daggregate_dinternaldafny_dtypes::GetAggregateInput::GetAggregateInput {
        simpleStringList:
        ::std::rc::Rc::new(
...
pub fn from_dafny(
    ...
    match &*dafny_value {
        crate::implementation_from_dafny::r#_simple_daggregate_dinternaldafny_dtypes::GetAggregateInput::GetAggregateInput {
            simpleStringList,
            structureList,
            simpleStringMap,
            simpleIntegerMap,
