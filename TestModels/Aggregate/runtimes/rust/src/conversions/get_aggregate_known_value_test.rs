...
pub fn to_dafny_error(
    ...
    match value {
    crate::operation::get_aggregate_known_value_test::GetAggregateKnownValueTestError::Unhandled(unhandled) =>
      ::std::rc::Rc::new(crate::r#simple::aggregate::internaldafny::types::Error::Opaque { obj: ::dafny_runtime::upcast_object()(::dafny_runtime::object::new(unhandled)) })
  }
}
