...
impl crate::r#simple::documentation::internaldafny::types::ISimpleDocumentationClient for Client {
    fn GetThing(
        &mut self,
        input: &::std::rc::Rc<crate::r#simple::documentation::internaldafny::types::GetThingInput>,
    ) -> std::rc::Rc<
        crate::r#_Wrappers_Compile::Result<
            ::std::rc::Rc<crate::r#simple::documentation::internaldafny::types::GetThingOutput>,
            std::rc::Rc<crate::r#simple::documentation::internaldafny::types::Error>,
        >,
    >{
        let inner_input = crate::conversions::get_thing::_get_thing_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::operation::get_thing::GetThing::send(&self.wrapped, inner_input))
        });
        match result {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::get_thing::_get_thing_output::to_dafny(inner_result),
                },
            ),
        }
    }
