...
pub fn to_dafny(
    ...
    ::std::rc::Rc::new(match value {
        crate::types::error::Error::CouldntGetTheThingError { message } =>
    crate::r#simple::documentation::internaldafny::types::Error::CouldntGetTheThingError {
        ...
        crate::types::error::Error::CollectionOfErrors { list, message } =>
            crate::r#simple::documentation::internaldafny::types::Error::CollectionOfErrors {
                message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::string_to_dafny_string(&message),
...
pub fn from_dafny(
    ...
    match ::std::borrow::Borrow::borrow(&dafny_value) {
        crate::r#simple::documentation::internaldafny::types::Error::CouldntGetTheThingError { message } =>
    crate::types::error::Error::CouldntGetTheThingError {
        message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(&message),
    },
        crate::r#simple::documentation::internaldafny::types::Error::CollectionOfErrors { list, message } =>
        ...
        crate::r#simple::documentation::internaldafny::types::Error::Opaque { obj, alt_text } =>
