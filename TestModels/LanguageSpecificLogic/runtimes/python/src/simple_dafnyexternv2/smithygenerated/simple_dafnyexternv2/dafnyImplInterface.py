...
class DafnyImplInterface:
    impl: SimpleExternV2Client | None = None
    ...
    def handle_request(self, input: DafnyRequest):
        if self.operation_map is None:
            self.operation_map = {
                "GetExternV2": self.impl.GetExternV2,
                "UseClassExternV2": self.impl.UseClassExternV2,
                "ExternV2MustError": self.impl.ExternV2MustError,
            }
