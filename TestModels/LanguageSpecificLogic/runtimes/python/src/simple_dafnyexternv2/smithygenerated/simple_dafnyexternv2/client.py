...
from simple_dafnyexternv2_internaldafny_types import ISimpleExternV2Client
from typing import Awaitable, Callable, TypeVar, cast

from .config import Config, SimpleExternV2Config
...
from smithygenerated.simple_dafnyexternv2.config import Plugin
from smithygenerated.simple_dafnyexternv2.deserialize import (
    _deserialize_extern_v2_must_error,
    _deserialize_get_extern_v2,
    _deserialize_use_class_extern_v2,
)
from smithygenerated.simple_dafnyexternv2.errors import ServiceError
...
from smithygenerated.simple_dafnyexternv2.serialize import (
    _serialize_extern_v2_must_error,
    _serialize_get_extern_v2,
    _serialize_use_class_extern_v2,
)
...
class SimpleExternV2:
    """Client for SimpleExternV2

    :param config: Configuration for the client.
    """
    def __init__(
        self,
        config: SimpleExternV2Config | None = None,
        dafny_client: ISimpleExternV2Client | None = None
    ):
        if config is None:
            self._config = Config()
        else:
    ...
    def get_extern_v2(self, input: GetExternV2Input) -> GetExternV2Output:
        """Invokes the GetExternV2 operation.
        ...
        return asyncio.run(self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_get_extern_v2,
            deserialize=_deserialize_get_extern_v2,
            config=self._config,
            operation_name="GetExternV2",
        ))

    def use_class_extern_v2(self, input: UseClassExternV2Input) -> UseClassExternV2Output:
        """Invokes the UseClassExternV2 operation.
        ...
        return asyncio.run(self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_use_class_extern_v2,
            deserialize=_deserialize_use_class_extern_v2,
            config=self._config,
            operation_name="UseClassExternV2",
        ))

    def extern_v2_must_error(self, input: ExternV2MustErrorInput) -> ExternV2MustErrorOutput:
        """Invokes the ExternV2MustError operation.
        ...
        return asyncio.run(self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_extern_v2_must_error,
            deserialize=_deserialize_extern_v2_must_error,
            config=self._config,
            operation_name="ExternV2MustError",
        ))
