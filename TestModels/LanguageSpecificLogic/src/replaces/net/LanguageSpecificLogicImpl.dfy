...
module {:extern "smithydafny.net.externs"} NetLanguageSpecificLogicImpl replaces LanguageSpecificLogicImpl  {
    ...
    method {:extern "getnetlanguage" } GetRuntimeInformationNetExternMethod(config: InternalConfig)
