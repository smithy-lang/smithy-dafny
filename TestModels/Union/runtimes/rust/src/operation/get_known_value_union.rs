...
impl GetKnownValueUnion {
    ...
    > {
        let inner_input = crate::conversions::get_known_value_union::_get_known_value_union_input::to_dafny(input);
        let inner_result =
...
pub(crate) mod _get_known_value_union_output;

pub(crate) mod _get_known_value_union_input;
