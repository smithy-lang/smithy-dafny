...
pub fn to_dafny_error(
    ...
    match value {
    crate::operation::get_union::GetUnionError::Unhandled(unhandled) =>
...
pub fn from_dafny_error(
    ...
    crate::operation::get_union::GetUnionError::generic(::aws_smithy_types::error::metadata::ErrorMetadata::builder().message(error_message).build())
  } else {
    crate::operation::get_union::GetUnionError::generic(::aws_smithy_types::error::metadata::ErrorMetadata::builder().message("Opaque error").build())
  }
}
