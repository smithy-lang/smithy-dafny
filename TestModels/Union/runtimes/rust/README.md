This directory is the code generation target for the SimpleUnion model when targetting Rust.
...
The main exception is `client.rs` and the operation builders such as `operation/get_union.rs`,
