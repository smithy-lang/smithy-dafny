module github.com/smithy-lang/smithy-dafny/TestModels/Union/test
...
require (
	...
	github.com/smithy-lang/smithy-dafny/TestModels/Union v0.0.0
)

replace github.com/smithy-lang/smithy-dafny/TestModels/Union v0.0.0 => ../ImplementationFromDafny-go
