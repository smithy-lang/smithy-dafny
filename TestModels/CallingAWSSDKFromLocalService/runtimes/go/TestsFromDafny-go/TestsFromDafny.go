...
func (_static *CompanionStruct_Default___) Test____Main____(__noArgsParameter _dafny.Sequence) {
	...
	_ = _0_success
	_0_success = true
	_dafny.Print((_dafny.SeqOfString("SimpleCallingAWSSDKFromLocalServiceImplTest.CallDDBScan: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			SimpleCallingAWSSDKFromLocalServiceImplTest.Companion_Default___.CallDDBScan()
			{
	...
	_dafny.Print((_dafny.SeqOfString("WrappedSimpleCallingAWSSDKFromLocalServiceTest.TestCallDDBScan: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			WrappedSimpleCallingAWSSDKFromLocalServiceTest.Companion_Default___.TestCallDDBScan()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
