...
func (_static *CompanionStruct_Default___) CallDDBScan(config Config, input SimpleCallingawssdkfromlocalserviceTypes.CallDDBScanInput) Wrappers.Result {
	...
	_ = output
	var _0_ScanInput ComAmazonawsDynamodbTypes.ScanInput
	_ = _0_ScanInput
	_0_ScanInput = ComAmazonawsDynamodbTypes.Companion_ScanInput_.Create_ScanInput_((input).Dtor_tableArn(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_(), Wrappers.Companion_Option_.Create_None_())
	var _1_retScan Wrappers.Result
	_ = _1_retScan
	var _out0 Wrappers.Result
	_ = _out0
	_out0 = ((input).Dtor_ddbClient()).Scan(_0_ScanInput)
	_1_retScan = _out0
	if (_1_retScan).Is_Success() {
		output = Wrappers.Companion_Result_.Create_Success_(SimpleCallingawssdkfromlocalserviceTypes.Companion_CallDDBScanOutput_.Create_CallDDBScanOutput_((((_1_retScan).Dtor_value().(ComAmazonawsDynamodbTypes.ScanOutput)).Dtor_Count()).UnwrapOr(int32(-1)).(int32)))
		return output
	} else {
		output = Wrappers.Companion_Result_.Create_Failure_(SimpleCallingawssdkfromlocalserviceTypes.Companion_Error_.Create_ComAmazonawsDynamodb_((_1_retScan).Dtor_error().(ComAmazonawsDynamodbTypes.Error)))
		return output
	}
	return output
}
func (_static *CompanionStruct_Default___) CallKMSEncrypt(config Config, input SimpleCallingawssdkfromlocalserviceTypes.CallKMSEncryptInput) Wrappers.Result {
	...
	if (_1_retEncryptResponse).Is_Success() {
		output = Wrappers.Companion_Result_.Create_Success_(SimpleCallingawssdkfromlocalserviceTypes.Companion_CallKMSEncryptOutput_.Create_CallKMSEncryptOutput_((((_1_retEncryptResponse).Dtor_value().(ComAmazonawsKmsTypes.EncryptResponse)).Dtor_KeyId()).UnwrapOr(_dafny.SeqOfString("")).(_dafny.Sequence)))
		return output
	} else {
