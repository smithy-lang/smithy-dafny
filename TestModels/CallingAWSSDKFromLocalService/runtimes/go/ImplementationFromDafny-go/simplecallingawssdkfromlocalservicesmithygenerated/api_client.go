...
func NewClient(clientConfig simplecallingawssdkfromlocalservicesmithygeneratedtypes.SimpleCallingAWSSDKFromLocalServiceConfig) (*Client, error) {
  ...
  func (client *Client) CallDDBScan(ctx context.Context , params simplecallingawssdkfromlocalservicesmithygeneratedtypes.CallDDBScanInput) (*simplecallingawssdkfromlocalservicesmithygeneratedtypes.CallDDBScanOutput, error) {
          err := params.Validate()
    if err != nil {
...
return nil, opaqueErr }
      var dafny_request SimpleCallingawssdkfromlocalserviceTypes.CallDDBScanInput = CallDDBScanInput_ToDafny(params)
var dafny_response = client.DafnyClient.CallDDBScan(dafny_request)

      if (dafny_response.Is_Failure()) {
          err := dafny_response.Dtor_error().(SimpleCallingawssdkfromlocalserviceTypes.Error);
          return nil, Error_FromDafny(err)
      }
      var native_response = CallDDBScanOutput_FromDafny(dafny_response.Extract().(SimpleCallingawssdkfromlocalserviceTypes.CallDDBScanOutput))
