...
dependencies {
    ...
    implementation("software.amazon.cryptography:ComAmazonawsKmsV2:1.0-SNAPSHOT")
    implementation("software.amazon.cryptography:ComAmazonawsDynamodbV2:1.0-SNAPSHOT")
