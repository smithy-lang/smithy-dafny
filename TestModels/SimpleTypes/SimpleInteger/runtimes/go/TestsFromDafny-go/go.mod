module github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleInteger/test
...
require (
	...
	github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleInteger v0.0.0
)

replace github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleInteger v0.0.0 => ../ImplementationFromDafny-go
