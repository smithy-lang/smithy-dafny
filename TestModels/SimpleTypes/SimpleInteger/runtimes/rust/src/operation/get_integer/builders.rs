...
impl crate::operation::get_integer::builders::GetIntegerInputBuilder {
...
impl GetIntegerFluentBuilder {
    /// Creates a new `GetIntegerFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_integer::GetInteger::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_integer::GetInteger::orchestrate(&runtime_plugins, input).await
    }
