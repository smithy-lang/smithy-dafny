...
pub fn to_dafny(
    ...
    crate::implementation_from_dafny::r#_simple_dtypes_dinteger_dinternaldafny_dtypes::GetIntegerOutput,
> {
    let dafny_value = match value.value {
        Some(b) => crate::implementation_from_dafny::_Wrappers_Compile::Option::Some { value: b },
        None => crate::implementation_from_dafny::_Wrappers_Compile::Option::None {},
    };
    ::std::rc::Rc::new(crate::implementation_from_dafny::r#_simple_dtypes_dinteger_dinternaldafny_dtypes::GetIntegerOutput::GetIntegerOutput {
