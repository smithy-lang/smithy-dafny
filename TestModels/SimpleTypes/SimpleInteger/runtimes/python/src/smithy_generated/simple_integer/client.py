...
from .deserialize import (
    _deserialize_get_integer,
    _deserialize_get_integer_known_value_test,
)
from .errors import ServiceError
from .models import (
    GetIntegerKnownValueTestInput,
    GetIntegerKnownValueTestOutput,
    GetIntegerOperationInput,
    GetIntegerOperationOutput,
)
from .serialize import _serialize_get_integer, _serialize_get_integer_known_value_test


Input = TypeVar("Input")
Output = TypeVar("Output")

class SimpleTypesInteger:
    """Client for SimpleTypesInteger
    ...
    async def get_integer(self, input: GetIntegerOperationInput, plugins: list[Plugin] | None = None) -> GetIntegerOperationOutput:
        """Invokes the GetInteger operation.
        ...
        return await self._execute_operation(
            ...
            serialize=_serialize_get_integer,
            deserialize=_deserialize_get_integer,
            config=self._config,
        )

    async def get_integer_known_value_test(self, input: GetIntegerKnownValueTestInput, plugins: list[Plugin] | None = None) -> GetIntegerKnownValueTestOutput:
        """Invokes the GetIntegerKnownValueTest operation.
        ...
        return await self._execute_operation(
            input=input,
            plugins=operation_plugins,
            serialize=_serialize_get_integer_known_value_test,
            deserialize=_deserialize_get_integer_known_value_test,
            config=self._config,
        )
