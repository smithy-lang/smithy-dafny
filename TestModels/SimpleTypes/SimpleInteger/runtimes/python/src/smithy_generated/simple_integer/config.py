...
_ServiceInterceptor = Union[Interceptor[GetIntegerOperationInput, GetIntegerOperationOutput, Any, Any], Interceptor[GetIntegerKnownValueTestInput, GetIntegerKnownValueTestOutput, Any, Any]]
@dataclass(kw_only=True)
class Config:
    """Configuration for SimpleTypesInteger
