...
from Dafny.Simpletypes.Boolean import SimpleBooleanClient
...
class SimpleBoolean:
    ...
    def __init__(self, config: Config | None = None, plugins: list[Plugin] | None = None):
        self._config = config or Config(interceptors=None, retry_strategy=None, impl=SimpleBooleanClient())

        # TODO add plugin to get impl from plugin?
    ...
    async def _execute_operation(
        ...
        input: Input,
        plugins: list[Plugin],
        serialize: Callable[[Input, Config], Awaitable[DafnyGetBooleanInput]],
        deserialize: Callable[[DafnyGetBooleanOutput, Config], Awaitable[Output]],
        config: Config,
    ) -> Output:
        try:
    ...
    async def _handle_execution(
        ...
        client_interceptors = cast(
            list[Interceptor[Input, Output, DafnyGetBooleanInput, DafnyGetBooleanOutput]], _client_interceptors
        )
        ...
        try:
            ...
            _client_interceptors = config.interceptors or []
            interceptors = cast(
                list[Interceptor[Input, Output, DafnyGetBooleanInput, DafnyGetBooleanOutput]],
            ...
            context_with_transport_request = cast(
                InterceptorContext[Input, None, DafnyGetBooleanInput, None], context
            )
            ...
            if retry_strategy is None:
                ...
                # )
                pass
            retry_token = None # retry_strategy.acquire_initial_retry_token()
        ...
        execution_context = cast(
            InterceptorContext[Input, Output, DafnyGetBooleanInput | None, DafnyGetBooleanOutput | None], context
        )
    ...
    async def _handle_attempt(
        self,
        deserialize: Callable[[DafnyGetBooleanOutput, Config], Awaitable[Output]],
        interceptors: list[Interceptor[Input, Output, DafnyGetBooleanInput, DafnyGetBooleanOutput]],
        context: InterceptorContext[Input, None, DafnyGetBooleanInput, None],
        config: Config,
    ) -> InterceptorContext[Input, Output, DafnyGetBooleanInput, DafnyGetBooleanOutput | None]:
        try:
            ...
            context_with_response = cast(
                InterceptorContext[Input, None,  DafnyGetBooleanInput, DafnyGetBooleanOutput], context
            )

            print(f"\ntransport_request is {context_with_response.transport_request}")
            ...
            context_with_output = cast(
                InterceptorContext[Input, Output, DafnyGetBooleanInput, DafnyGetBooleanOutput],
        ...
        attempt_context = cast(
            InterceptorContext[Input, Output, DafnyGetBooleanInput, DafnyGetBooleanOutput | None], context
        )
    ...
    async def _finalize_attempt(
        self,
        interceptors: list[Interceptor[Input, Output, DafnyGetBooleanInput, DafnyGetBooleanOutput]],
        context: InterceptorContext[Input, Output, DafnyGetBooleanInput, DafnyGetBooleanOutput | None],
    ) -> InterceptorContext[Input, Output, DafnyGetBooleanInput, DafnyGetBooleanOutput | None]:
    ...
    async def _finalize_execution(
        self,
        interceptors: list[Interceptor[Input, Output, DafnyGetBooleanInput, DafnyGetBooleanOutput]],
        context: InterceptorContext[Input, Output, DafnyGetBooleanInput | None, DafnyGetBooleanOutput | None],
    ) -> Output:
        try:
