...
from . import set_config_impl
from smithy_python.exceptions import SmithyRetryException
from smithy_python.interfaces.http import IaAmDafny, IamaAlsoDafny
...
class SimpleBoolean:
    ...
    async def _execute_operation(
        ...
        input: Input,
        plugins: list[Plugin],
        serialize: Callable[[Input, Config], Awaitable[IaAmDafny]],
        deserialize: Callable[[IamaAlsoDafny, Config], Awaitable[Output]],
        config: Config,
    ) -> Output:
        try:
    ...
    async def _handle_execution(
        ...
        client_interceptors = cast(
            list[Interceptor[Input, Output, IaAmDafny, IamaAlsoDafny]], _client_interceptors
        )
        ...
        try:
            ...
            _client_interceptors = config.interceptors or []
            interceptors = cast(
                list[Interceptor[Input, Output, IaAmDafny, IamaAlsoDafny]],
            ...
            context_with_transport_request = cast(
                InterceptorContext[Input, None, IaAmDafny, None], context
            )
        ...
        execution_context = cast(
            InterceptorContext[Input, Output, IaAmDafny | None, IamaAlsoDafny | None], context
        )
    ...
    async def _handle_attempt(
        self,
        deserialize: Callable[[IamaAlsoDafny, Config], Awaitable[Output]],
        interceptors: list[Interceptor[Input, Output, IaAmDafny, IamaAlsoDafny]],
        context: InterceptorContext[Input, None, IaAmDafny, None],
        config: Config,
    ) -> InterceptorContext[Input, Output, IaAmDafny, IamaAlsoDafny | None]:
        try:
            ...
            context_with_output = cast(
                InterceptorContext[Input, Output, IaAmDafny, IamaAlsoDafny],
        ...
        attempt_context = cast(
            InterceptorContext[Input, Output, IaAmDafny, IamaAlsoDafny | None], context
        )
    ...
    async def _finalize_attempt(
        self,
        interceptors: list[Interceptor[Input, Output, IaAmDafny, IamaAlsoDafny]],
        context: InterceptorContext[Input, Output, IaAmDafny, IamaAlsoDafny | None],
    ) -> InterceptorContext[Input, Output, IaAmDafny, IamaAlsoDafny | None]:
    ...
    async def _finalize_execution(
        self,
        interceptors: list[Interceptor[Input, Output, IaAmDafny, IamaAlsoDafny]],
        context: InterceptorContext[Input, Output, IaAmDafny | None, IamaAlsoDafny | None],
    ) -> Output:
        try:
