...
assert "StandardLibrary_mUInt_Compile" == __name__
StandardLibrary_mUInt_Compile = sys.modules[__name__]
...
class default__:
    ...
    @staticmethod
    def HasUint16Len(s):
        return (len(s)) < ((StandardLibrary_mUInt_Compile.default__).UINT16__LIMIT)

    @staticmethod
    def HasUint32Len(s):
        return (len(s)) < ((StandardLibrary_mUInt_Compile.default__).UINT32__LIMIT)

    @staticmethod
    def HasUint64Len(s):
        return (len(s)) < ((StandardLibrary_mUInt_Compile.default__).UINT64__LIMIT)
