...
class default__:
    ...
    def SimpleBoolean(config):
        ...
        d_72_client_: simple.types.boolean.internaldafny.impl.SimpleBooleanClient
        nw1_ = simple.types.boolean.internaldafny.impl.SimpleBooleanClient()
        nw1_.ctor__(SimpleBooleanImpl_Compile.Config_Config())
        d_72_client_ = nw1_
        res = Wrappers_Compile.Result_Success(d_72_client_)
        return res
        return res
