...
class default__:
    ...
    @staticmethod
    def GetBooleanTrue():
        d_0_client_: simple_types_boolean_internaldafny_index.SimpleBooleanClient
        d_1_valueOrError0_: Wrappers.Result = None
        out0_: Wrappers.Result
        out0_ = simple_types_boolean_internaldafny_index.default__.SimpleBoolean(simple_types_boolean_internaldafny_index.default__.DefaultSimpleBooleanConfig())
    ...
    @staticmethod
    def GetBooleanFalse():
        d_2_client_: simple_types_boolean_internaldafny_index.SimpleBooleanClient
        d_3_valueOrError0_: Wrappers.Result = None
        out1_: Wrappers.Result
        out1_ = simple_types_boolean_internaldafny_index.default__.SimpleBoolean(simple_types_boolean_internaldafny_index.default__.DefaultSimpleBooleanConfig())
