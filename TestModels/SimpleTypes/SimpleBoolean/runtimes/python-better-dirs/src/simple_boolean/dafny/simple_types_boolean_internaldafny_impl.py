...
# assert "simple_types_boolean_internaldafny_impl" == __name__
print("ehrae")
print(sys.modules)
simple_types_boolean_internaldafny_impl = sys.modules[__name__]
...
class default__:
    ...
    def SimpleBoolean(config):
        ...
        d_1_client_: simple_types_boolean_internaldafny_impl.SimpleBooleanClient
        nw0_ = simple_types_boolean_internaldafny_impl.SimpleBooleanClient()
...
class SimpleBooleanClient(
    simple_types_boolean_internaldafny_types.ISimpleTypesBooleanClient):
    def  __init__(self):
