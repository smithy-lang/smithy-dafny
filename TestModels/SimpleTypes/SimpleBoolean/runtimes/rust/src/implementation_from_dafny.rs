    ...
    pub mod types {
        pub mod boolean {
            pub mod internaldafny {
                pub use crate::simple::types::boolean::internaldafny::types::ISimpleTypesBooleanClient;
                ...
                impl _default {
                    ...
                    pub fn SimpleBoolean(
                        config: &::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::SimpleBooleanConfig>,
                    ) -> ::std::rc::Rc<
                        crate::r#_Wrappers_Compile::Result<
                            ...
                            >,
                            ::std::rc::Rc<
                                crate::simple::types::boolean::internaldafny::types::Error,
                            >,
                        >,
                    > {
                        let mut res = ::dafny_runtime::MaybePlacebo::<::std::rc::Rc<crate::r#_Wrappers_Compile::Result<::dafny_runtime::Object<crate::simple::types::boolean::internaldafny::SimpleBooleanClient>, ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>>>>::new();
                        let mut client = ::dafny_runtime::MaybePlacebo::<
                            ::dafny_runtime::Object<
                                crate::simple::types::boolean::internaldafny::SimpleBooleanClient,
                            >,
                        >::new();
                        let mut _nw1: ::dafny_runtime::Object<crate::simple::types::boolean::internaldafny::SimpleBooleanClient> = crate::simple::types::boolean::internaldafny::SimpleBooleanClient::_allocate_object();
                        crate::simple::types::boolean::internaldafny::SimpleBooleanClient::_ctor(
                            &_nw1,
                            &::std::rc::Rc::new(
                                crate::r#_SimpleBooleanImpl_Compile::Config::Config {},
                            ),
                        );
                        client = ::dafny_runtime::MaybePlacebo::from(_nw1.clone());
                        res = ::dafny_runtime::MaybePlacebo::from(::std::rc::Rc::new(crate::r#_Wrappers_Compile::Result::<::dafny_runtime::Object<crate::simple::types::boolean::internaldafny::SimpleBooleanClient>, ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>>::Success {
                    value: client.read()
                  }));
                        return res.read();
                    }
                    pub fn CreateSuccessOfClient(client: &::dafny_runtime::Object<dyn crate::simple::types::boolean::internaldafny::types::ISimpleTypesBooleanClient>) -> ::std::rc::Rc<crate::r#_Wrappers_Compile::Result<::dafny_runtime::Object<dyn crate::simple::types::boolean::internaldafny::types::ISimpleTypesBooleanClient>, ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>>>{
                        ::std::rc::Rc::new(crate::r#_Wrappers_Compile::Result::<::dafny_runtime::Object<dyn crate::simple::types::boolean::internaldafny::types::ISimpleTypesBooleanClient>, ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>>::Success {
                value: client.clone()
              })
                    }
                    pub fn CreateFailureOfError(error: &::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>) -> ::std::rc::Rc<crate::r#_Wrappers_Compile::Result<::dafny_runtime::Object<dyn crate::simple::types::boolean::internaldafny::types::ISimpleTypesBooleanClient>, ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>>>{
                        ::std::rc::Rc::new(crate::r#_Wrappers_Compile::Result::<::dafny_runtime::Object<dyn crate::simple::types::boolean::internaldafny::types::ISimpleTypesBooleanClient>, ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>>::Failure {
                error: error.clone()
              })
                    }
                }
                ...
                pub struct SimpleBooleanClient {
                    pub r#__i_config: ::std::rc::Rc<crate::r#_SimpleBooleanImpl_Compile::Config>,
                }
                ...
                impl SimpleBooleanClient {
                    ...
                    pub fn _ctor(
                        this: &::dafny_runtime::Object<
                            crate::simple::types::boolean::internaldafny::SimpleBooleanClient,
                        >,
                        config: &::std::rc::Rc<crate::r#_SimpleBooleanImpl_Compile::Config>,
                    ) -> () {
                    ...
                    pub fn config(
                        &self,
                    ) -> ::std::rc::Rc<crate::r#_SimpleBooleanImpl_Compile::Config>
                    {
                        self.r#__i_config.clone()
                    }
                }

                impl UpcastObject<dyn Any> for crate::simple::types::boolean::internaldafny::SimpleBooleanClient {
                    ::dafny_runtime::UpcastObjectFn!(dyn::std::any::Any);
                }

                impl ISimpleTypesBooleanClient
                    for crate::simple::types::boolean::internaldafny::SimpleBooleanClient
                {
                    fn GetBoolean(&mut self, input: &::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::GetBooleanInput>) -> ::std::rc::Rc<crate::r#_Wrappers_Compile::Result<::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::GetBooleanOutput>, ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>>>{
                        let mut output = ::dafny_runtime::MaybePlacebo::<::std::rc::Rc<crate::r#_Wrappers_Compile::Result<::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::GetBooleanOutput>, ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>>>>::new();
                        let mut _out0 = ::dafny_runtime::MaybePlacebo::<::std::rc::Rc<crate::r#_Wrappers_Compile::Result<::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::GetBooleanOutput>, ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>>>>::new();
                        _out0 = ::dafny_runtime::MaybePlacebo::from(
                            crate::r#_SimpleBooleanImpl_Compile::_default::GetBoolean(
                                &self.config().clone(),
                                input,
                            ),
                        );
                ...
                impl UpcastObject<dyn ISimpleTypesBooleanClient>
                    for crate::simple::types::boolean::internaldafny::SimpleBooleanClient
                {
                    ::dafny_runtime::UpcastObjectFn!(dyn crate::simple::types::boolean::internaldafny::types::ISimpleTypesBooleanClient);
                }
                ...
                pub mod types {
                        ...
                        fn fmt_print(
                            ...
                            match self {
                                DafnyCallEvent::DafnyCallEvent { input, output } => {
                                    write!(_formatter, "simple.types.boolean.internaldafny.types.DafnyCallEvent.DafnyCallEvent(")?;
                    ...
                    pub enum GetBooleanInput {
                        GetBooleanInput {
                            value: ::std::rc::Rc<crate::r#_Wrappers_Compile::Option<bool>>,
                        },
                    }
                    ...
                    impl Debug for GetBooleanInput {
                        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                            ::dafny_runtime::DafnyPrint::fmt_print(self, f, true)
                        }
                    }

                    impl DafnyPrint for GetBooleanInput {
                        fn fmt_print(
                            &self,
                            _formatter: &mut ::std::fmt::Formatter,
                            _in_seq: bool,
                            ...
                            match self {
                                GetBooleanInput::GetBooleanInput { value } => {
                                    write!(_formatter, "simple.types.boolean.internaldafny.types.GetBooleanInput.GetBooleanInput(")?;
                                    ::dafny_runtime::DafnyPrint::fmt_print(
                    ...
                    impl Default for GetBooleanInput {
                    ...
                    impl AsRef<GetBooleanInput> for &GetBooleanInput {
                        fn as_ref(&self) -> Self {
                            self
                        }
                    }
                    ...
                    impl Debug for GetBooleanOutput {
                        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                            ::dafny_runtime::DafnyPrint::fmt_print(self, f, true)
                        }
                    }

                    impl DafnyPrint for GetBooleanOutput {
                        fn fmt_print(
                            &self,
                            _formatter: &mut ::std::fmt::Formatter,
                            _in_seq: bool,
                            ...
                            match self {
                                GetBooleanOutput::GetBooleanOutput { value } => {
                                    write!(_formatter, "simple.types.boolean.internaldafny.types.GetBooleanOutput.GetBooleanOutput(")?;
                                    ::dafny_runtime::DafnyPrint::fmt_print(
                                        value, _formatter, false,
                                    )?;
                                    write!(_formatter, ")")?;
                    ...
                    impl Hash for GetBooleanOutput {
                        fn hash<_H: ::std::hash::Hasher>(&self, _state: &mut _H) {
                            match self {
                                GetBooleanOutput::GetBooleanOutput { value } => {
                                    ::std::hash::Hash::hash(value, _state)
                    ...
                    impl Default for GetBooleanOutput {
                    ...
                    impl AsRef<GetBooleanOutput> for &GetBooleanOutput {
                        fn as_ref(&self) -> Self {
                            self
                        }
                    }
                    ...
                    impl Debug for SimpleBooleanConfig {
                        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                            ::dafny_runtime::DafnyPrint::fmt_print(self, f, true)
                        }
                    }

                    impl DafnyPrint for SimpleBooleanConfig {
                        fn fmt_print(
                            &self,
                            _formatter: &mut ::std::fmt::Formatter,
                            _in_seq: bool,
                            ...
                            match self {
                                SimpleBooleanConfig::SimpleBooleanConfig {} => {
                                    write!(_formatter, "simple.types.boolean.internaldafny.types.SimpleBooleanConfig.SimpleBooleanConfig")?;
                                    Ok(())
                                }
                            }
                        }
                    ...
                    impl Hash for SimpleBooleanConfig {
                        fn hash<_H: ::std::hash::Hasher>(&self, _state: &mut _H) {
                            match self {
                                SimpleBooleanConfig::SimpleBooleanConfig {} => {}
                            }
                    ...
                    impl Default for SimpleBooleanConfig {
                        fn default() -> SimpleBooleanConfig {
                            SimpleBooleanConfig::SimpleBooleanConfig {}
                        }
                    }

                    impl AsRef<SimpleBooleanConfig> for &SimpleBooleanConfig {
                        fn as_ref(&self) -> Self {
                            self
                        }
                    }
            ...
            for crate::simple::types::boolean::internaldafny::types::ISimpleTypesBooleanClientCallHistory {
            ::dafny_runtime::UpcastObjectFn!(dyn ::std::any::Any);
          }
                    ...
                    impl DafnyPrint for Error {
                        fn fmt_print(
                            ...
                            match self {
                                Error::CollectionOfErrors { list, message } => {
                                    write!(_formatter, "simple.types.boolean.internaldafny.types.Error.CollectionOfErrors(")?;
                                    ::dafny_runtime::DafnyPrint::fmt_print(
                                ...
                                Error::Opaque { obj } => {
                                    write!(
                                        _formatter,
                                        "simple.types.boolean.internaldafny.types.Error.Opaque("
                                    )?;
...
pub mod r#_SimpleBooleanImpl_Compile {
    ...
    impl _default {
        pub fn GetBoolean(
            config: &::std::rc::Rc<crate::r#_SimpleBooleanImpl_Compile::Config>,
            input: &::std::rc::Rc<
                crate::simple::types::boolean::internaldafny::types::GetBooleanInput,
            >,
        ) -> ::std::rc::Rc<
            crate::r#_Wrappers_Compile::Result<
                ::std::rc::Rc<
        ...
        > {
            ...
            if !(input.value().value().clone() == true || input.value().value().clone() == false) {
                panic!("Halt")
            };
            let mut res: ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::GetBooleanOutput> = ::std::rc::Rc::new(crate::simple::types::boolean::internaldafny::types::GetBooleanOutput::GetBooleanOutput {
            value: input.value().clone()
          });
            if !(res.value().value().clone() == true || res.value().value().clone() == false) {
                panic!("Halt")
            };
            let mut _e00: bool = input.value().value().clone();
            let mut _e10: bool = res.value().value().clone();
            if !(_e00 == _e10) {
                print!(
                    "{}",
    ...
    impl _default {
        ...
        pub fn GetBooleanFalse() -> () {
            ...
            let mut _out2 = ::dafny_runtime::MaybePlacebo::<
                ...
                >,
            >::new();
            _out2 = ::dafny_runtime::MaybePlacebo::from(crate::simple::types::boolean::internaldafny::_default::SimpleBoolean(&crate::simple::types::boolean::internaldafny::_default::DefaultSimpleBooleanConfig()));
        ...
        pub fn TestGetBooleanTrue(
            ...
            let mut ret: ::std::rc::Rc<
                crate::simple::types::boolean::internaldafny::types::GetBooleanOutput,
            > = valueOrError0.read().Extract();
            let mut _e01: bool = ret.value().UnwrapOr(&false);
            let mut _e11: bool = true;
            if !(_e01 == _e11) {
                print!(
                    "{}",
                    ::dafny_runtime::DafnyPrintWrapper(&::dafny_runtime::string_utf16_of(
        ...
        pub fn TestGetBooleanFalse(
            ...
            let mut _out4 = ::dafny_runtime::MaybePlacebo::<
                ...
                >,
            >::new();
            _out4 = ::dafny_runtime::MaybePlacebo::from(crate::simple::types::boolean::internaldafny::types::ISimpleTypesBooleanClient::GetBoolean(::dafny_runtime::md!(client.clone()), &::std::rc::Rc::new(crate::simple::types::boolean::internaldafny::types::GetBooleanInput::GetBooleanInput {
                value: ::std::rc::Rc::new(crate::r#_Wrappers_Compile::Option::<bool>::Some {
                      value: false
                    })
              })));
            ...
            let mut ret: ::std::rc::Rc<
                crate::simple::types::boolean::internaldafny::types::GetBooleanOutput,
            > = valueOrError0.read().Extract();
            let mut _e02: bool = ret.value().UnwrapOr(&true);
            let mut _e12: bool = false;
            if !(_e02 == _e12) {
                print!(
                    "{}",
                    ::dafny_runtime::DafnyPrintWrapper(&::dafny_runtime::string_utf16_of(
...
pub mod r#_WrappedSimpleTypesBooleanTest_Compile {
    ...
    impl _default {
        ...
        pub fn GetBooleanFalse() -> () {
            let mut valueOrError0 = ::dafny_runtime::MaybePlacebo::<::std::rc::Rc<crate::r#_Wrappers_Compile::Result<::dafny_runtime::Object<dyn crate::simple::types::boolean::internaldafny::types::ISimpleTypesBooleanClient>, ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>>>>::new();
            let mut _out6 = ::dafny_runtime::MaybePlacebo::<::std::rc::Rc<crate::r#_Wrappers_Compile::Result<::dafny_runtime::Object<dyn crate::simple::types::boolean::internaldafny::types::ISimpleTypesBooleanClient>, ::std::rc::Rc<crate::simple::types::boolean::internaldafny::types::Error>>>>::new();
            _out6 = ::dafny_runtime::MaybePlacebo::from(crate::simple::types::boolean::internaldafny::wrapped::_default::WrappedSimpleBoolean(&crate::simple::types::boolean::internaldafny::wrapped::_default::WrappedDefaultSimpleBooleanConfig()));
