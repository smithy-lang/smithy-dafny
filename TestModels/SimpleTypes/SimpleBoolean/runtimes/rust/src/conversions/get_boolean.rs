...
pub fn to_dafny_error(
    ...
    crate::operation::get_boolean::GetBooleanError::Unhandled(unhandled) =>
      ::std::rc::Rc::new(simple_boolean_dafny::r#simple::types::boolean::internaldafny::types::Error::Opaque { obj: ::dafny_runtime::upcast_object()(::dafny_runtime::object::new(unhandled)) })
  }
}
...
pub fn from_dafny_error(
    dafny_value: ::std::rc::Rc<
        simple_boolean_dafny::r#simple::types::boolean::internaldafny::types::Error,
    >,
) -> crate::operation::get_boolean::GetBooleanError {
    // TODO: Losing information here, but we have to figure out how to wrap an arbitrary Dafny value as std::error::Error
    if matches!(&dafny_value.as_ref(), simple_boolean_dafny::r#simple::types::boolean::internaldafny::types::Error::CollectionOfErrors { .. }) {
