...
impl super::r#_simple_dtypes_dboolean_dinternaldafny_dtypes::ISimpleTypesBooleanClient for WrappedClient {
    fn GetBoolean(
        &mut self,
        input: &std::rc::Rc<
            implementation_from_dafny::r#_simple_dtypes_dboolean_dinternaldafny_dtypes::GetBooleanInput,
        >,
    ) -> std::rc::Rc<
        implementation_from_dafny::r#_Wrappers_Compile::Result<
            std::rc::Rc<
                implementation_from_dafny::r#_simple_dtypes_dboolean_dinternaldafny_dtypes::GetBooleanOutput,
            >,
            std::rc::Rc<implementation_from_dafny::r#_simple_dtypes_dboolean_dinternaldafny_dtypes::Error>,
        >,
    > {
      let inner_input = crate::conversions::get_boolean::_get_boolean_input::from_dafny(input.clone());
...
>) -> ::std::rc::Rc<super::r#_Wrappers_Compile::Result<::dafny_runtime::Object<dyn super::r#_simple_dtypes_dboolean_dinternaldafny_dtypes::ISimpleTypesBooleanClient>, ::std::rc::Rc<super::r#_simple_dtypes_dboolean_dinternaldafny_dtypes::Error>>> {
    ...
    match result {
      Err(error) => {
        ...
        ::dafny_runtime::Object(Some(::std::rc::Rc::new(::std::cell::UnsafeCell::new(error))));
        ::std::rc::Rc::new( crate::implementation_from_dafny::_Wrappers_Compile::Result::Failure { 
          error: ::std::rc::Rc::new(super::r#_simple_dtypes_dboolean_dinternaldafny_dtypes::Error::Opaque { obj: error_obj }) 
        })
      },
      Ok(client) => {
        let wrap = WrappedClient { wrapped: client.clone() };
        let inner: ::std::rc::Rc<::std::cell::UnsafeCell<dyn super::r#_simple_dtypes_dboolean_dinternaldafny_dtypes::ISimpleTypesBooleanClient>>
           = ::std::rc::Rc::new(::std::cell::UnsafeCell::new(wrap));

        ::std::rc::Rc::new( crate::implementation_from_dafny::_Wrappers_Compile::Result::Success { 
