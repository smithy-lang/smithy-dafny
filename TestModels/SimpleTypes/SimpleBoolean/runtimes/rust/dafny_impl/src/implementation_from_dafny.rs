...
pub mod r#_simple_dtypes_dboolean_dinternaldafny_dtypes {
        ...
        fn fmt_print(
            ...
            match self {
                DafnyCallEvent::DafnyCallEvent { input, output } => {
                    write!(
                        _formatter,
                        "simple.types.boolean.internaldafny.types.DafnyCallEvent.DafnyCallEvent("
                    )?;
        ...
        fn fmt_print(
            ...
            match self {
                GetBooleanInput::GetBooleanInput { value } => {
                    write!(
                        _formatter,
                        "simple.types.boolean.internaldafny.types.GetBooleanInput.GetBooleanInput("
                    )?;
    ...
    for super::r#_simple_dtypes_dboolean_dinternaldafny_dtypes::ISimpleTypesBooleanClientCallHistory {
        ...
        fn fmt_print(
            ...
            match self {
                Error::CollectionOfErrors { list, message } => {
                    write!(
                        _formatter,
                        "simple.types.boolean.internaldafny.types.Error.CollectionOfErrors("
                    )?;
...
pub mod r#_SimpleBooleanImpl_Compile {
    ...
    impl _default {
        ...
        > {
            ...
            if !(input.value().value().clone() == res.value().value().clone()) {
                panic!("Halt")
            };
    ...
    impl ::dafny_runtime::UpcastObject<dyn::std::any::Any>
        for super::r#_SimpleBooleanImpl_Compile::_default
    {
        ::dafny_runtime::UpcastObjectFn!(dyn::std::any::Any);
    }
...
pub mod r#_simple_dtypes_dboolean_dinternaldafny {
    ...
    impl _default {
        ...
        > {
            ...
            let mut client = ::dafny_runtime::MaybePlacebo::<
                ...
                >,
            >::new();
            let mut _nw0: ::dafny_runtime::Object<super::r#_simple_dtypes_dboolean_dinternaldafny::SimpleBooleanClient> = super::r#_simple_dtypes_dboolean_dinternaldafny::SimpleBooleanClient::_allocate_object();
    ...
    impl ::dafny_runtime::UpcastObject<dyn::std::any::Any>
        for super::r#_simple_dtypes_dboolean_dinternaldafny::_default
    {
        ::dafny_runtime::UpcastObjectFn!(dyn::std::any::Any);
    }
        ...
        for super::r#_simple_dtypes_dboolean_dinternaldafny::SimpleBooleanClient
    {
        ...
        > {
            ...
            _out0 = ::dafny_runtime::MaybePlacebo::from(
                super::r#_SimpleBooleanImpl_Compile::_default::GetBoolean(
                    &self.config().clone(),
                    input,
                ),
            );
    ...
    impl
        ::dafny_runtime::UpcastObject<
            dyn super::r#_simple_dtypes_dboolean_dinternaldafny_dtypes::ISimpleTypesBooleanClient,
        > for super::r#_simple_dtypes_dboolean_dinternaldafny::SimpleBooleanClient
    {
        ::dafny_runtime::UpcastObjectFn!(dyn super::r#_simple_dtypes_dboolean_dinternaldafny_dtypes::ISimpleTypesBooleanClient);
    }
}
pub mod _module {}
