module github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleLong/test
...
require (
	...
	github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleLong v0.0.0
)

replace github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleLong v0.0.0 => ../ImplementationFromDafny-go
