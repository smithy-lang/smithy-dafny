...
pub mod r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes {
        ...
        fn fmt_print(
            ...
            match self {
                DafnyCallEvent::DafnyCallEvent { input, output } => {
                    write!(_formatter, "r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes.DafnyCallEvent.DafnyCallEvent(")?;
    ...
    pub enum GetLongInput {
        GetLongInput {
            value: ::std::rc::Rc<super::r#_Wrappers_Compile::Option<i64>>,
        },
    }

    impl GetLongInput {
        pub fn value(&self) -> &::std::rc::Rc<super::r#_Wrappers_Compile::Option<i64>> {
            match self {
    ...
    impl ::std::fmt::Debug for GetLongInput {
        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> std::fmt::Result {
            ::dafny_runtime::DafnyPrint::fmt_print(self, f, true)
        }
    }

    impl ::dafny_runtime::DafnyPrint for GetLongInput {
        fn fmt_print(
            &self,
            _formatter: &mut ::std::fmt::Formatter,
            _in_seq: bool,
            ...
            match self {
                GetLongInput::GetLongInput { value } => {
                    write!(_formatter, "r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes.GetLongInput.GetLongInput(")?;
    ...
    impl ::std::hash::Hash for GetLongInput {
        fn hash<_H: ::std::hash::Hasher>(&self, _state: &mut _H) {
            match self {
                GetLongInput::GetLongInput { value } => value.hash(_state),
            }
        }
    }

    impl ::std::default::Default for GetLongInput {
    ...
    impl ::std::convert::AsRef<GetLongInput> for &GetLongInput {
        fn as_ref(&self) -> Self {
            self
        }
    }
    ...
    impl ::std::fmt::Debug for GetLongOutput {
        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> std::fmt::Result {
            ::dafny_runtime::DafnyPrint::fmt_print(self, f, true)
        }
    }

    impl ::dafny_runtime::DafnyPrint for GetLongOutput {
        fn fmt_print(
            &self,
            _formatter: &mut ::std::fmt::Formatter,
            _in_seq: bool,
            ...
            match self {
                GetLongOutput::GetLongOutput { value } => {
                    write!(_formatter, "r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes.GetLongOutput.GetLongOutput(")?;
                    ::dafny_runtime::DafnyPrint::fmt_print(value, _formatter, false)?;
                    write!(_formatter, ")")?;
                    Ok(())
                }
    ...
    impl ::std::hash::Hash for GetLongOutput {
        fn hash<_H: ::std::hash::Hasher>(&self, _state: &mut _H) {
            match self {
                GetLongOutput::GetLongOutput { value } => value.hash(_state),
            }
        }
    }

    impl ::std::default::Default for GetLongOutput {
    ...
    impl ::std::convert::AsRef<GetLongOutput> for &GetLongOutput {
        fn as_ref(&self) -> Self {
            self
        }
    }
    ...
    impl ::std::fmt::Debug for SimpleLongConfig {
        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> std::fmt::Result {
            ::dafny_runtime::DafnyPrint::fmt_print(self, f, true)
        }
    }

    impl ::dafny_runtime::DafnyPrint for SimpleLongConfig {
        fn fmt_print(
            &self,
            _formatter: &mut ::std::fmt::Formatter,
            _in_seq: bool,
            ...
            match self {
                SimpleLongConfig::SimpleLongConfig {} => {
                    write!(_formatter, "r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes.SimpleLongConfig.SimpleLongConfig")?;
                    Ok(())
                }
            }
        }
    ...
    impl ::std::hash::Hash for SimpleLongConfig {
        fn hash<_H: ::std::hash::Hasher>(&self, _state: &mut _H) {
            match self {
                SimpleLongConfig::SimpleLongConfig {} => {}
            }
    ...
    impl ::std::default::Default for SimpleLongConfig {
        fn default() -> SimpleLongConfig {
            SimpleLongConfig::SimpleLongConfig {}
        }
    }

    impl ::std::convert::AsRef<SimpleLongConfig> for &SimpleLongConfig {
        fn as_ref(&self) -> Self {
            self
        }
    }
    ...
    pub trait ISimpleTypesLongClient {
        fn GetLong(
            &mut self,
            input: &::std::rc::Rc<
                super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::GetLongInput,
            >,
        ) -> ::std::rc::Rc<
            super::r#_Wrappers_Compile::Result<
                ::std::rc::Rc<
                    super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::GetLongOutput,
                >,
    ...
    impl ::dafny_runtime::DafnyPrint for Error {
        fn fmt_print(
            ...
            match self {
                Error::CollectionOfErrors { list, message } => {
                    write!(_formatter, "r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes.Error.CollectionOfErrors(")?;
                ...
                Error::Opaque { obj } => {
                    write!(
                        _formatter,
                        "r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes.Error.Opaque("
                    )?;
...
pub mod r#_SimpleLongImpl_Compile {
    ...
    impl _default {
        ...
        pub fn GetLong(
            config: &::std::rc::Rc<super::r#_SimpleLongImpl_Compile::Config>,
            input: &::std::rc::Rc<
                super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::GetLongInput,
            >,
        ) -> ::std::rc::Rc<
            ...
            >,
        > {
            let mut output = ::dafny_runtime::MaybePlacebo::<::std::rc::Rc<super::r#_Wrappers_Compile::Result<::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::GetLongOutput>, ::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::Error>>>>::new();
            if !matches!(
                input.value().as_ref(),
            ...
            res = ::std::rc::Rc::new(super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::GetLongOutput::GetLongOutput {
            value: input.value().clone()
          });
            if !matches!(
                res.value().as_ref(),
    ...
    impl ::dafny_runtime::DafnyPrint for Config {
        fn fmt_print(
            ...
            match self {
                Config::Config {} => {
                    write!(_formatter, "r#_SimpleLongImpl_Compile.Config.Config")?;
                    Ok(())
                }
            }
        }
...
pub mod r#_simple_dtypes_dsmithylong_dinternaldafny {
    ...
    impl _default {
        ...
        pub fn DefaultSimpleLongConfig() -> ::std::rc::Rc<
            super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::SimpleLongConfig,
        > {
            ::std::rc::Rc::new(super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::SimpleLongConfig::SimpleLongConfig {})
        }
        pub fn SimpleLong(
            config: &::std::rc::Rc<
                super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::SimpleLongConfig,
        ...
        pub fn CreateSuccessOfClient(client: &::dafny_runtime::Object<dyn super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::ISimpleTypesLongClient>) -> ::std::rc::Rc<super::r#_Wrappers_Compile::Result<::dafny_runtime::Object<dyn super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::ISimpleTypesLongClient>, ::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::Error>>>{
            ::std::rc::Rc::new(super::r#_Wrappers_Compile::Result::<::dafny_runtime::Object<dyn super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::ISimpleTypesLongClient>, ::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::Error>>::Success {
          value: client.clone()
        })
        }
        pub fn CreateFailureOfError(error: &::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::Error>) -> ::std::rc::Rc<super::r#_Wrappers_Compile::Result<::dafny_runtime::Object<dyn super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::ISimpleTypesLongClient>, ::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::Error>>>{
            ::std::rc::Rc::new(super::r#_Wrappers_Compile::Result::<::dafny_runtime::Object<dyn super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::ISimpleTypesLongClient>, ::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::Error>>::Failure {
          error: error.clone()
        })
        }
    }
    ...
    pub struct SimpleLongClient {
        pub r#__i_config: ::std::rc::Rc<super::r#_SimpleLongImpl_Compile::Config>,
    }
    ...
    impl SimpleLongClient {
        ...
        pub fn config(&self) -> ::std::rc::Rc<super::r#_SimpleLongImpl_Compile::Config> {
        ...
        for super::r#_simple_dtypes_dsmithylong_dinternaldafny::SimpleLongClient
    {
        ...
        > {
            let mut output = ::dafny_runtime::MaybePlacebo::<::std::rc::Rc<super::r#_Wrappers_Compile::Result<::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::GetLongOutput>, ::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::Error>>>>::new();
            let mut _out0 = ::dafny_runtime::MaybePlacebo::<::std::rc::Rc<super::r#_Wrappers_Compile::Result<::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::GetLongOutput>, ::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::Error>>>>::new();
            _out0 = ::dafny_runtime::MaybePlacebo::from(
                super::r#_SimpleLongImpl_Compile::_default::GetLong(&self.config(), input),
            );
        ...
        > {
            let mut output = ::dafny_runtime::MaybePlacebo::<::std::rc::Rc<super::r#_Wrappers_Compile::Result<::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::GetLongOutput>, ::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::Error>>>>::new();
            let mut _out1 = ::dafny_runtime::MaybePlacebo::<::std::rc::Rc<super::r#_Wrappers_Compile::Result<::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::GetLongOutput>, ::std::rc::Rc<super::r#_simple_dtypes_dsmithylong_dinternaldafny_dtypes::Error>>>>::new();
            _out1 = ::dafny_runtime::MaybePlacebo::from(
                super::r#_SimpleLongImpl_Compile::_default::GetLongKnownValueTest(
                    &self.config(),
                    input,
                ),
            );
