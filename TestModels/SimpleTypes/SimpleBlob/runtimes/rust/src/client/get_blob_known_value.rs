...
impl super::Client {
    ...
    ///   - [`value(impl Into<Vec<u8>>)`](crate::operation::get_blob_known_value::builders::GetBlobFluentBuilder::value) / [`set_value(Option<Vec<u8>>)`](crate::operation::get_blob_known_value::builders::GetBlobFluentBuilder::set_value):(undocumented)<br>
