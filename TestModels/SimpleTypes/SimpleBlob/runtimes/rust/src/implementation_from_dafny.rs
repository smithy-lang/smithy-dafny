                ...
                impl _default {
                    ...
                    > {
                        ...
                        let mut client = ::dafny_runtime::MaybePlacebo::<
                            ...
                            >,
                        >::new();
                        let mut _nw1: ::dafny_runtime::Object<crate::simple::types::blob::internaldafny::SimpleBlobClient> = crate::simple::types::blob::internaldafny::SimpleBlobClient::_allocate_object();
...
pub mod r#_SimpleBlobImpl_Compile {
    ...
    impl _default {
        ...
        pub fn ValidateBlobType(input: &::dafny_runtime::Sequence<u8>) -> () {
            ...
            let mut _hi1: ::dafny_runtime::DafnyInt = input.cardinality();
