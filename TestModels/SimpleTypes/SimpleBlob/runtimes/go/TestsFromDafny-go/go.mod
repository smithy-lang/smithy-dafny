module github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleBlob/test
...
require (
	...
	github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleBlob v0.0.0
)
