...
pub fn to_dafny(
    ...
    ::simple_timestamp_dafny::r#_simple_dtypes_dtimestamp_dinternaldafny_dtypes::GetTimestampOutput,
> {
    ...
    ::std::rc::Rc::new(::simple_timestamp_dafny::r#_simple_dtypes_dtimestamp_dinternaldafny_dtypes::GetTimestampOutput::GetTimestampOutput {
