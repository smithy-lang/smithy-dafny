...
pub fn to_dafny(
    ...
    crate::implementation_from_dafny::r#_simple_dtypes_dtimestamp_dinternaldafny_dtypes::GetTimestampOutput,
> {
    ...
    ::std::rc::Rc::new(crate::implementation_from_dafny::r#_simple_dtypes_dtimestamp_dinternaldafny_dtypes::GetTimestampOutput::GetTimestampOutput {
