            ...
            pub mod internaldafny {
                ...
                impl _default {
                    ...
                    pub fn SimpleTimestamp(config: &::std::rc::Rc<crate::simple::types::timestamp::internaldafny::types::SimpleTimestampConfig>) -> ::std::rc::Rc<crate::r#_Wrappers_Compile::Result<::dafny_runtime::Object<crate::simple::types::timestamp::internaldafny::SimpleTimestampClient>, ::std::rc::Rc<crate::simple::types::timestamp::internaldafny::types::Error>>>{
                        ...
                        let mut _nw1: ::dafny_runtime::Object<crate::simple::types::timestamp::internaldafny::SimpleTimestampClient> = crate::simple::types::timestamp::internaldafny::SimpleTimestampClient::_allocate_object();
                        crate::simple::types::timestamp::internaldafny::SimpleTimestampClient::_ctor(&_nw1, &::std::rc::Rc::new(crate::r#_SimpleTypesTimestampImpl_Compile::Config::Config {}));
