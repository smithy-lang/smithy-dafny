...
pub fn to_dafny(
    ...
    simple_string_dafny::r#simple::types::smithystring::internaldafny::types::GetStringOutput,
> {
    ...
    ::std::rc::Rc::new(simple_string_dafny::r#simple::types::smithystring::internaldafny::types::GetStringOutput::GetStringOutput {
...
#[allow(dead_code)]
pub fn from_dafny(
    dafny_value: ::std::rc::Rc<simple_string_dafny::r#simple::types::smithystring::internaldafny::types::GetStringOutput>,
