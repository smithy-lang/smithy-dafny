...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::get_string_utf8_known_value::GetStringUTF8KnownValueInput,
) -> ::std::rc::Rc<
...
pub fn from_dafny(
    ...
    crate::operation::get_string_utf8_known_value::GetStringUTF8KnownValueInput { value }
}
