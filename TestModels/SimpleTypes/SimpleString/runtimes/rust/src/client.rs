...
pub struct Client {
    pub(crate) dafny_client: ::dafny_runtime::Object<dyn simple_string_dafny::r#simple::types::smithystring::internaldafny::types::ISimpleTypesStringClient>
}
...
impl Client {
    ...
    pub fn from_conf(
        ...
        let inner =
            simple_string_dafny::simple::types::smithystring::internaldafny::_default::SimpleString(
