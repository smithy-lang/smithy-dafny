...
pub struct Client {
    pub(crate) dafny_client: ::dafny_runtime::Object<dyn ::simple_string_dafny::r#_simple_dtypes_dsmithystring_dinternaldafny_dtypes::ISimpleTypesStringClient>
}
...
impl Client {
    ...
    pub fn from_conf(
        ...
        let inner =
            ::simple_string_dafny::_simple_dtypes_dsmithystring_dinternaldafny::_default::SimpleString(
