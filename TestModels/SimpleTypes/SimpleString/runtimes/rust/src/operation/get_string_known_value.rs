...
impl GetStringKnownValue {
    ...
    pub(crate) async fn send(
        ...
        input: crate::operation::get_string_known_value::GetStringInput,
    ) -> ::std::result::Result<
        crate::operation::get_string_known_value::GetStringOutput,
        crate::operation::get_string_known_value::GetStringKnownValueError,
    > {
        let inner_input = crate::conversions::get_string_known_value::_get_string_known_value_input::to_dafny(input);
        let inner_result =
            ::dafny_runtime::md!(client.dafny_client.clone()).GetStringKnownValue(&inner_input);
        if matches!(
            inner_result.as_ref(),
            crate::r#_Wrappers_Compile::Result::Success { .. }
        ) {
            Ok(
                crate::conversions::get_string_known_value::_get_string_known_value_output::from_dafny(
                    inner_result.value().clone(),
                ),
            )
        } else {
            Err(crate::conversions::get_string_known_value::from_dafny_error(
...
pub use crate::operation::get_string_known_value::_get_string_output::GetStringOutput;

pub use crate::operation::get_string_known_value::_get_string_input::GetStringInput;

pub(crate) mod _get_string_output;

pub(crate) mod _get_string_input;
