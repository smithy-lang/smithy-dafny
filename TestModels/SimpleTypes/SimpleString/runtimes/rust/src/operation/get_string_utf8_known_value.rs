...
impl GetStringUTF8KnownValue {
    ...
    pub(crate) async fn send(
        ...
        input: crate::operation::get_string_utf8_known_value::GetStringUTF8KnownValueInput,
    ) -> ::std::result::Result<
    ...
    > {
        let inner_input =
            crate::conversions::get_string_utf8_known_value::_get_string_utf8_known_value_input::to_dafny(input);
        let inner_result =
...
pub use crate::operation::get_string_utf8_known_value::_get_string_utf8_known_value_output::GetStringUTF8KnownValueOutput;

pub use crate::operation::get_string_utf8_known_value::_get_string_utf8_known_value_input::GetStringUTF8KnownValueInput;

mod _get_string_utf8_known_value_input;

mod _get_string_utf8_known_value_output;
