...
pub mod r#_simple_dtypes_dsmithystring_dinternaldafny_dtypes {
    ...
    impl ::std::fmt::Debug for GetStringInput {
        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> std::fmt::Result {
            ::dafny_runtime::DafnyPrint::fmt_print(self, f, true)
        }
    }
    ...
    impl ::std::hash::Hash for GetStringInput {
        fn hash<_H: ::std::hash::Hasher>(&self, _state: &mut _H) {
            match self {
                GetStringInput::GetStringInput { value } => value.hash(_state),
            }
        }
    }
    ...
    impl ::std::fmt::Debug for GetStringOutput {
        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> std::fmt::Result {
            ::dafny_runtime::DafnyPrint::fmt_print(self, f, true)
        }
    }
    ...
    impl ::std::hash::Hash for GetStringOutput {
        fn hash<_H: ::std::hash::Hasher>(&self, _state: &mut _H) {
            match self {
                GetStringOutput::GetStringOutput { value } => value.hash(_state),
            }
        }
    }
    ...
    impl ::std::fmt::Debug for SimpleStringConfig {
        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> std::fmt::Result {
            ::dafny_runtime::DafnyPrint::fmt_print(self, f, true)
        }
    }
    ...
    impl ::std::hash::Hash for SimpleStringConfig {
        fn hash<_H: ::std::hash::Hasher>(&self, _state: &mut _H) {
            match self {
                SimpleStringConfig::SimpleStringConfig {} => {}
            }
        ...
        fn fmt_print(
            ...
            match self {
                ...
                Error::Opaque { obj } => {
                    write!(
                        _formatter,
                        "r#_simple_dtypes_dsmithystring_dinternaldafny_dtypes.Error.Opaque("
                    )?;
...
pub mod r#_simple_dtypes_dsmithystring_dinternaldafny {
    ...
    impl _default {
        ...
        pub fn DefaultSimpleStringConfig() -> ::std::rc::Rc<
        ...
        pub fn SimpleString(
            ...
            super::r#_Wrappers_Compile::Result<
                ::dafny_runtime::Object<
                    super::r#_simple_dtypes_dsmithystring_dinternaldafny::SimpleStringClient,
                >,
                ::std::rc::Rc<super::r#_simple_dtypes_dsmithystring_dinternaldafny_dtypes::Error>,
            >,
        > {
            let mut res = ::dafny_runtime::MaybePlacebo::<::std::rc::Rc<super::r#_Wrappers_Compile::Result<::dafny_runtime::Object<super::r#_simple_dtypes_dsmithystring_dinternaldafny::SimpleStringClient>, ::std::rc::Rc<super::r#_simple_dtypes_dsmithystring_dinternaldafny_dtypes::Error>>>>::new();
            ...
            super::r#_simple_dtypes_dsmithystring_dinternaldafny::SimpleStringClient::_ctor(
                &_nw0,
            ...
            res = ::dafny_runtime::MaybePlacebo::from(::std::rc::Rc::new(
                super::r#_Wrappers_Compile::Result::<
                    ...
                    >,
                    ::std::rc::Rc<
                        super::r#_simple_dtypes_dsmithystring_dinternaldafny_dtypes::Error,
                    >,
                >::Success {
                    value: client.read(),
                },
        ...
        for super::r#_simple_dtypes_dsmithystring_dinternaldafny::SimpleStringClient
    {
        ...
        > {
            ...
            _out1 = ::dafny_runtime::MaybePlacebo::from(
                super::r#_SimpleStringImpl_Compile::_default::GetStringKnownValue(
                    &self.config(),
                    input,
                ),
            );
