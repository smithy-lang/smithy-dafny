module github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleString/test
...
require (
	...
	github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleString v0.0.0
)
