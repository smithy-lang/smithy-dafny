...
module {:extern "simple.types.smithydouble.internaldafny.wrapped"} WrappedSimpleTypesSmithyDoubleService refines WrappedAbstractSimpleTypesSmithyDoubleService
{
