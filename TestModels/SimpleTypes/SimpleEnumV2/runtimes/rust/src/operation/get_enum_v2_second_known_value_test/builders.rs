...
pub use crate::operation::get_enum_v2_second_known_value_test::_get_enum_v2_output::GetEnumV2OutputBuilder;

pub use crate::operation::get_enum_v2_second_known_value_test::_get_enum_v2_input::GetEnumV2InputBuilder;
...
pub struct GetEnumV2SecondKnownValueTestFluentBuilder {
    ...
    pub(crate) inner: crate::operation::get_enum_v2_second_known_value_test::builders::GetEnumV2InputBuilder,
}
impl GetEnumV2SecondKnownValueTestFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_enum_v2_second_known_value_test::builders::GetEnumV2InputBuilder {
        &self.inner
    }
    ...
    > {
        let input = self
            .inner
            .build()
            // Using unhandled since GetEnumV2SecondKnownValueTest doesn't declare any validation,
        ...
        crate::operation::get_enum_v2_second_known_value_test::GetEnumV2SecondKnownValueTest::send(&self.client, input).await
    }
