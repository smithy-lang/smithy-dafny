...
impl GetEnumV2ThirdKnownValueTest {
    ...
    pub(crate) async fn send(
        ...
        input: crate::operation::get_enum_v2_third_known_value_test::GetEnumV2Input,
    ) -> ::std::result::Result<
    ...
    > {
        let inner_input = crate::conversions::get_enum_v2_third_known_value_test::_get_enum_v2_third_known_value_test_input::to_dafny(input);
        let inner_result =
            ::dafny_runtime::md!(client.dafny_client.clone()).GetEnumV2ThirdKnownValueTest(&inner_input);
        if matches!(
            inner_result.as_ref(),
            ...
            Err(crate::conversions::get_enum_v2_third_known_value_test::from_dafny_error(
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetEnumV2ThirdKnownValueTestError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetEnumV2ThirdKnownValueTestError {
...
pub use crate::operation::get_enum_v2_third_known_value_test::_get_enum_v2_output::GetEnumV2Output;

pub use crate::operation::get_enum_v2_third_known_value_test::_get_enum_v2_input::GetEnumV2Input;
