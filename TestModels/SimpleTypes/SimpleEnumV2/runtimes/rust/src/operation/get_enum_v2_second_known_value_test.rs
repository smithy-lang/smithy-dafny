...
impl GetEnumV2SecondKnownValueTest {
    ...
    pub(crate) async fn send(
        ...
        input: crate::operation::get_enum_v2_second_known_value_test::GetEnumV2Input,
    ) -> ::std::result::Result<
        crate::operation::get_enum_v2_second_known_value_test::GetEnumV2Output,
        crate::operation::get_enum_v2_second_known_value_test::GetEnumV2SecondKnownValueTestError,
    > {
        let inner_input = crate::conversions::get_enum_v2_second_known_value_test::_get_enum_v2_second_known_value_test_input::to_dafny(input);
        let inner_result =
            ::dafny_runtime::md!(client.dafny_client.clone()).GetEnumV2SecondKnownValueTest(&inner_input);
        if matches!(
            inner_result.as_ref(),
            ...
            Err(crate::conversions::get_enum_v2_second_known_value_test::from_dafny_error(
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetEnumV2SecondKnownValueTestError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetEnumV2SecondKnownValueTestError {
...
pub use crate::operation::get_enum_v2_second_known_value_test::_get_enum_v2_output::GetEnumV2Output;

pub use crate::operation::get_enum_v2_second_known_value_test::_get_enum_v2_input::GetEnumV2Input;
