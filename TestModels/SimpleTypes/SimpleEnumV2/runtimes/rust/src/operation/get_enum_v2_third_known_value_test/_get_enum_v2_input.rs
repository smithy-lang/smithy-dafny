...
impl GetEnumV2Input {
    ...
    pub fn builder() -> crate::operation::get_enum_v2_third_known_value_test::builders::GetEnumV2InputBuilder {
        crate::operation::get_enum_v2_third_known_value_test::builders::GetEnumV2InputBuilder::default()
    }
}
...
pub fn get_value(&self) -> &::std::option::Option<crate::types::SimpleEnumV2Shape> {
    ...
    pub fn build(
        ...
        crate::operation::get_enum_v2_third_known_value_test::GetEnumV2Input,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::get_enum_v2_third_known_value_test::GetEnumV2Input {
            value: self.value,
        })
    }
}
