...
impl GetEnumV2Output {
    ...
    pub fn builder() -> crate::operation::get_enum_v2_third_known_value_test::builders::GetEnumV2OutputBuilder {
        crate::operation::get_enum_v2_third_known_value_test::builders::GetEnumV2OutputBuilder::default()
    }
}
...
pub fn get_value(&self) -> &::std::option::Option<crate::types::SimpleEnumV2Shape> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_enum_v2_third_known_value_test::GetEnumV2Output {
            value: self.value,
        })
    }
}
