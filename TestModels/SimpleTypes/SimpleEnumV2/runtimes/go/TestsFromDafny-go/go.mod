module github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleEnumV2/test
...
require (
	...
	github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleEnumV2 v0.0.0
)

replace github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleEnumV2 v0.0.0 => ../ImplementationFromDafny-go
