...
impl GetEnumInput {
    ...
    pub fn builder() -> crate::operation::get_enum_first_known_value_test::builders::GetEnumInputBuilder {
        crate::operation::get_enum_first_known_value_test::builders::GetEnumInputBuilder::default()
    }
}
...
pub fn get_value(&self) -> &::std::option::Option<crate::types::SimpleEnumShape> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_enum_first_known_value_test::GetEnumInput {
            value: self.value,
        })
    }
}
