...
impl GetEnumOutput {
    ...
    pub fn builder() -> crate::operation::get_enum_first_known_value_test::builders::GetEnumOutputBuilder {
        crate::operation::get_enum_first_known_value_test::builders::GetEnumOutputBuilder::default()
    }
}
...
pub fn get_value(&self) -> &::std::option::Option<crate::types::SimpleEnumShape> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_enum_first_known_value_test::GetEnumOutput {
            value: self.value,
        })
    }
}
