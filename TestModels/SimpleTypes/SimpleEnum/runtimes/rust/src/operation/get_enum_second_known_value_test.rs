...
impl GetEnumSecondKnownValueTest {
    ...
    pub(crate) async fn send(
        ...
        input: crate::operation::get_enum_second_known_value_test::GetEnumInput,
    ) -> ::std::result::Result<
    ...
    > {
        let inner_input = crate::conversions::get_enum_second_known_value_test::_get_enum_second_known_value_test_input::to_dafny(input);
        let inner_result =
            ::dafny_runtime::md!(client.dafny_client.clone()).GetEnumSecondKnownValueTest(&inner_input);
        if matches!(
            inner_result.as_ref(),
            ...
            Err(crate::conversions::get_enum_second_known_value_test::from_dafny_error(
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetEnumSecondKnownValueTestError {
...
pub use crate::operation::get_enum_second_known_value_test::_get_enum_output::GetEnumOutput;

pub use crate::operation::get_enum_second_known_value_test::_get_enum_input::GetEnumInput;
