module github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleEnum/test
...
require (
	...
	github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleEnum v0.0.0
)

replace github.com/smithy-lang/smithy-dafny/TestModels/SimpleTypes/SimpleEnum v0.0.0 => ../ImplementationFromDafny-go
