...
from .config import Config, Plugin, smithy_config_to_dafny_config, SimpleEnumConfig
...
def set_config_impl(config: Config):
    ...
    if isinstance(config, SimpleEnumConfig):
        from simple_types_smithyenum_internaldafny import default__
        config.dafnyImplInterface.impl = default__.SimpleEnum(smithy_config_to_dafny_config(config)).value
