...
from simple_types_smithyenum_internaldafny_types import ISimpleTypesEnumClient
from typing import Awaitable, Callable, TypeVar, cast

from .config import Config, SimpleEnumConfig
...
from .deserialize import (
    _deserialize_get_enum,
    _deserialize_get_enum_first_known_value_test,
    _deserialize_get_enum_second_known_value_test,
    _deserialize_get_enum_third_known_value_test,
)
from .errors import ServiceError
from .models import GetEnumInput, GetEnumOutput
from .serialize import (
    _serialize_get_enum,
    _serialize_get_enum_first_known_value_test,
    _serialize_get_enum_second_known_value_test,
    _serialize_get_enum_third_known_value_test,
)
...
class SimpleTypesEnum:
    """Client for SimpleTypesEnum

    :param config: Configuration for the client.
    """
    def __init__(
        self,
        config: SimpleEnumConfig | None = None,
        dafny_client: ISimpleTypesEnumClient | None = None
    ):
        if config is None:
            self._config = Config()
        else:
    ...
    def get_enum(self, input: GetEnumInput) -> GetEnumOutput:
        """Invokes the GetEnum operation.
        ...
        return asyncio.run(self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_get_enum,
            deserialize=_deserialize_get_enum,
            config=self._config,
            operation_name="GetEnum",
        ))

    def get_enum_first_known_value_test(self, input: GetEnumInput) -> GetEnumOutput:
        """Invokes the GetEnumFirstKnownValueTest operation.
        ...
        return asyncio.run(self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_get_enum_first_known_value_test,
            deserialize=_deserialize_get_enum_first_known_value_test,
            config=self._config,
            operation_name="GetEnumFirstKnownValueTest",
        ))

    def get_enum_second_known_value_test(self, input: GetEnumInput) -> GetEnumOutput:
        """Invokes the GetEnumSecondKnownValueTest operation.
        ...
        return asyncio.run(self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_get_enum_second_known_value_test,
            deserialize=_deserialize_get_enum_second_known_value_test,
            config=self._config,
            operation_name="GetEnumSecondKnownValueTest",
        ))

    def get_enum_third_known_value_test(self, input: GetEnumInput) -> GetEnumOutput:
        """Invokes the GetEnumThirdKnownValueTest operation.
        ...
        return asyncio.run(self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_get_enum_third_known_value_test,
            deserialize=_deserialize_get_enum_third_known_value_test,
            config=self._config,
            operation_name="GetEnumThirdKnownValueTest",
        ))
