...
mod TestUTF8 {
    ...
    fn TestEncodeHappyCase() {
        ...
        let expectedBytes = dafny_runtime::seq![0x61, 0x62, 0x63, 0xCC, 0x86, 0xC7, 0xBD, 0xCE, 0xB2];
        let _r =
          implementation_from_dafny::r#_UTF8_Compile::_default::Encode(&unicodeString);
        if _r.IsFailure() {
            panic!("Encode failed");
        }
