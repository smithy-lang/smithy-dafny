...
func (_this Option) ToResult() Result {
	{
		...
		_ = _source0
		if _source0.Is_None() {
			return Companion_Result_.Create_Failure_(_dafny.UnicodeSeqOfUtf8Bytes("Option is None"))
		} else {
...
func (_this Result) ToOption() Option {
	{
		...
		if _source2.Is_Success() {
			var _4___mcc_h0 interface{} = _source2.Get_().(Result_Success).Value
			_ = _4___mcc_h0
			var _5_s interface{} = _4___mcc_h0
			_ = _5_s
			return Companion_Option_.Create_Some_(_5_s)
		} else {
			var _6___mcc_h1 interface{} = _source2.Get_().(Result_Failure).Error
			_ = _6___mcc_h1
...
func (_this Result) UnwrapOr(default_ interface{}) interface{} {
	{
		...
		if _source3.Is_Success() {
			var _8___mcc_h0 interface{} = _source3.Get_().(Result_Success).Value
			_ = _8___mcc_h0
			var _9_s interface{} = _8___mcc_h0
			_ = _9_s
			return _9_s
		} else {
			var _10___mcc_h1 interface{} = _source3.Get_().(Result_Failure).Error
			_ = _10___mcc_h1
...
func (_this Result) MapFailure(reWrap func(interface{}) interface{}) Result {
	{
		...
		if _source4.Is_Success() {
			var _12___mcc_h0 interface{} = _source4.Get_().(Result_Success).Value
			_ = _12___mcc_h0
			var _13_s interface{} = _12___mcc_h0
			_ = _13_s
			return Companion_Result_.Create_Success_(_13_s)
		} else {
			var _14___mcc_h1 interface{} = _source4.Get_().(Result_Failure).Error
			_ = _14___mcc_h1
