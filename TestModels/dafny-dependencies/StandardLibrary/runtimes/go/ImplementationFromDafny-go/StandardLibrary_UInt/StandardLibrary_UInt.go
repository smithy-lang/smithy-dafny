...
func (*Uint8) String() string {
	return "StandardLibrary_UInt.Uint8"
}
...
func (*Uint16) String() string {
	return "StandardLibrary_UInt.Uint16"
}
...
func (*Uint32) String() string {
	return "StandardLibrary_UInt.Uint32"
}
...
func (*Uint64) String() string {
	return "StandardLibrary_UInt.Uint64"
}
...
func (*Int32) String() string {
	return "StandardLibrary_UInt.Int32"
}
...
func (*Int64) String() string {
	return "StandardLibrary_UInt.Int64"
}
...
func (*PosInt64) String() string {
	return "StandardLibrary_UInt.PosInt64"
}
...
func (_this *CompanionStruct_PosInt64_) Is_(__source uint64) bool {
	var _50_x _dafny.Int = _dafny.IntOfUint64(__source)
	_ = _50_x
	return ((_50_x).Sign() == 1) && ((_50_x).Cmp(_dafny.IntOfString("9223372036854775808")) < 0)
}
...
func (_this *CompanionStruct_Seq16_) Is_(__source _dafny.Sequence) bool {
	var _51_s _dafny.Sequence = (__source)
	_ = _51_s
	return Companion_Default___.HasUint16Len(_51_s)
}
...
func (_this *CompanionStruct_Seq32_) Is_(__source _dafny.Sequence) bool {
	var _52_s _dafny.Sequence = (__source)
	_ = _52_s
	return Companion_Default___.HasUint32Len(_52_s)
}
...
func (_this *CompanionStruct_Seq64_) Is_(__source _dafny.Sequence) bool {
	var _53_s _dafny.Sequence = (__source)
	_ = _53_s
	return Companion_Default___.HasUint64Len(_53_s)
}
