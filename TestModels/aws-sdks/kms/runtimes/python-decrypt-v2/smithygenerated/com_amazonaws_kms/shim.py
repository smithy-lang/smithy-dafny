...
import Wrappers
import asyncio
import com_amazonaws_kms_internaldafny_types
...
class TrentServiceShim(com_amazonaws_kms_internaldafny_types.ITrentServiceClient):
    ...
    def Decrypt(self, input: DafnyDecryptRequest) -> DafnyDecryptResponse:
        ...
        try:
            wrapped_response = asyncio.run(self._impl.decrypt(unwrapped_request))
        except ServiceError as e:
            return Wrappers.Result_Failure(smithy_error_to_dafny_error(e))
