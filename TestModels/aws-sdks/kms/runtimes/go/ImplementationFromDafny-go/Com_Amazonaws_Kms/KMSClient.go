...
func (CompanionStruct_Default___) KMSClient() Wrappers.Result {
...
func (CompanionStruct_Default___) RegionMatch(k ComAmazonawsKmsTypes.IKMSClient, S _dafny.Sequence) Wrappers.Option {
	var r = func() *string {
		var s string
