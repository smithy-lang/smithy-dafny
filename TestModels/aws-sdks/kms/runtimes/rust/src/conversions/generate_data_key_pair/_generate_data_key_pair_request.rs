...
,
 ...
 KeyPairSpec: crate::conversions::data_key_pair_spec::to_dafny(value.key_pair_spec.clone().unwrap()),
...
pub fn from_dafny(
 ...
 .set_key_pair_spec(Some( crate::conversions::data_key_pair_spec::from_dafny(dafny_value.KeyPairSpec()) ))
