...
>{
 ...
 KeyPairSpec: ::std::rc::Rc::new(match &value.key_pair_spec {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::data_key_pair_spec::to_dafny(x.clone()) },
...
pub fn from_dafny(
 ...
 .set_key_pair_spec(match &**dafny_value.KeyPairSpec() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        crate::conversions::data_key_pair_spec::from_dafny(value)
    ),
    _ => None,
}
)
