...
>{
 ...
 SigningAlgorithm: ::std::rc::Rc::new(match &value.signing_algorithm {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::signing_algorithm_spec::to_dafny(x.clone()) },
...
pub fn from_dafny(
 ...
 .set_signing_algorithm(match &**dafny_value.SigningAlgorithm() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        crate::conversions::signing_algorithm_spec::from_dafny(value)
    ),
    _ => None,
}
)
