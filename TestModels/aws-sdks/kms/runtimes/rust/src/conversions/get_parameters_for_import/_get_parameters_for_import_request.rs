...
>{
 ...
 WrappingAlgorithm: crate::conversions::algorithm_spec::to_dafny(value.wrapping_algorithm.clone().unwrap()),
 WrappingKeySpec: crate::conversions::wrapping_key_spec::to_dafny(value.wrapping_key_spec.clone().unwrap()),
    })
}
 #[allow(dead_code)]
pub fn from_dafny(
 ...
 .set_wrapping_algorithm(Some( crate::conversions::algorithm_spec::from_dafny(dafny_value.WrappingAlgorithm()) ))
 .set_wrapping_key_spec(Some( crate::conversions::wrapping_key_spec::from_dafny(dafny_value.WrappingKeySpec()) ))
          .build()
          .unwrap()
}
