 ...
 Operations: ::std::rc::Rc::new(match &value.operations {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(x,
            |e| crate::conversions::grant_operation::to_dafny(e.clone()),
        )
    },
...
,
 Constraints: ::std::rc::Rc::new(match &value.constraints {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::grant_constraints::to_dafny(x) },
...
pub fn from_dafny(
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e: &::std::rc::Rc<crate::software::amazon::cryptography::services::kms::internaldafny::types::GrantOperation>| crate::conversions::grant_operation::from_dafny(e),
            )
        ),
    _ => None
}
 ...
 .set_constraints(match (*dafny_value.Constraints()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(crate::conversions::grant_constraints::from_dafny(value.clone())),
    _ => None,
}
)
          .build()
