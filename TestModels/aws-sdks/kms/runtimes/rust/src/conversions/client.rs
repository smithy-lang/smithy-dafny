...
{
  let x: std::rc::Rc<crate::client::Client> = std::rc::Rc::new(value.clone());
...
pub fn from_dafny(
  ...
  if (dafny_runtime::is_object!(as_boxed_any, crate::client::Client)) {
    let as_boxed_client = ::dafny_runtime::object::downcast::<crate::client::Client>(as_boxed_any);
    unsafe {
