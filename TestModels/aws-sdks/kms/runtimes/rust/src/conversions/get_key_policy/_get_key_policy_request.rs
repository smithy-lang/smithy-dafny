...
>{
 ...
 PolicyName: crate::standard_library_conversions::ostring_to_dafny(&value.policy_name) .Extract(),
    })
}
 #[allow(dead_code)]
pub fn from_dafny(
 ...
 .set_policy_name(Some( dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(dafny_value.PolicyName()) ))
          .build()
          .unwrap()
}
