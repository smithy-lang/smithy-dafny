...
,
 KeyState: ::std::rc::Rc::new(match &value.key_state {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::key_state::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
...
,
 ...
 ExpirationModel: ::std::rc::Rc::new(match &value.expiration_model {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::expiration_model_type::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 KeyManager: ::std::rc::Rc::new(match &value.key_manager {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::key_manager_type::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
...
,
 ...
 MultiRegionConfiguration: ::std::rc::Rc::new(match &value.multi_region_configuration {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::multi_region_configuration::to_dafny(x) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
...
pub fn from_dafny(
 ...
 .set_key_state(match &**dafny_value.KeyState() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        crate::conversions::key_state::from_dafny(value)
    ),
    _ => None,
}
)
 ...
 .set_expiration_model(match &**dafny_value.ExpirationModel() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        crate::conversions::expiration_model_type::from_dafny(value)
    ),
    _ => None,
}
)
 .set_key_manager(match &**dafny_value.KeyManager() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        crate::conversions::key_manager_type::from_dafny(value)
    ),
    _ => None,
}
)
 ...
 .set_multi_region_configuration(match (*dafny_value.MultiRegionConfiguration()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(crate::conversions::multi_region_configuration::from_dafny(value.clone())),
    _ => None,
}
)
