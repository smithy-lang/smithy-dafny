...
pub fn to_dafny(
  ...
  ::std::rc::Rc::new(
    ...
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::multi_region_key_type::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 PrimaryKey: ::std::rc::Rc::new(match &value.primary_key {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::multi_region_key::to_dafny(x) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 ReplicaKeys: ::std::rc::Rc::new(match &value.replica_keys {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(x,
            |e| crate::conversions::multi_region_key::to_dafny(e)
,
        )
    },
...
pub fn from_dafny(
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        crate::conversions::multi_region_key_type::from_dafny(value)
    ),
    _ => None,
}
)
 .set_primary_key(match (*dafny_value.PrimaryKey()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(crate::conversions::multi_region_key::from_dafny(value.clone())),
    _ => None,
}
)
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e: &::std::rc::Rc<crate::r#software::amazon::cryptography::services::kms::internaldafny::types::MultiRegionKey>| crate::conversions::multi_region_key::from_dafny(e.clone())
,
            )
        ),
    _ => None
