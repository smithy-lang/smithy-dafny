...
,
 ...
 MacAlgorithms: ::std::rc::Rc::new(match &value.mac_algorithms {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(x,
            |e| crate::conversions::mac_algorithm_spec::to_dafny(e.clone()),
        )
    },
    None => crate::r#_Wrappers_Compile::Option::None {}
})
,
 XksKeyConfiguration: ::std::rc::Rc::new(match &value.xks_key_configuration {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::xks_key_configuration_type::to_dafny(&x) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
    }
...
pub fn from_dafny(
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e| crate::conversions::encryption_algorithm_spec::from_dafny(e),
            )
        ),
    _ => None
}
 ...
 .set_signing_algorithms(match (*dafny_value.SigningAlgorithms()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e| crate::conversions::signing_algorithm_spec::from_dafny(e),
            )
        ),
    _ => None
}
 ...
 .set_key_agreement_algorithms(match (*dafny_value.KeyAgreementAlgorithms()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e| crate::conversions::key_agreement_algorithm_spec::from_dafny(e),
            )
        ),
    _ => None
}
 ...
 .set_mac_algorithms(match (*dafny_value.MacAlgorithms()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e| crate::conversions::mac_algorithm_spec::from_dafny(e),
            )
        ),
    _ => None
}
 ...
 .set_xks_key_configuration(match (*dafny_value.XksKeyConfiguration()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(crate::conversions::xks_key_configuration_type::from_dafny(value.clone())),
    _ => None,
}
)
          .build()
