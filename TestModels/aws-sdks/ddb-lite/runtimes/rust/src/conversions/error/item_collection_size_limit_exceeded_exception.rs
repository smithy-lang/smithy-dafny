...
pub fn to_dafny(
  ...
  ::std::rc::Rc::new(
    crate::implementation_from_dafny::r#_software_damazon_dcryptography_dservices_ddynamodb_dinternaldafny_dtypes::Error::ItemCollectionSizeLimitExceededException {
