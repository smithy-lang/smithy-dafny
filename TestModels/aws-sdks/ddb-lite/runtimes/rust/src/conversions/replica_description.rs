...
pub fn to_dafny(
 ...
 ReplicaStatus: ::std::rc::Rc::new(match &value.replica_status {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::replica_status::to_dafny(x.clone()) },
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e: &::std::rc::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::ReplicaGlobalSecondaryIndexDescription>| crate::conversions::replica_global_secondary_index_description::from_dafny(e.clone())
,
            )
        ),
    _ => None
