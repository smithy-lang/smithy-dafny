...
pub fn from_dafny(
    ...
    aws_sdk_dynamodb::types::GlobalSecondaryIndexDescription::builder()
        ...
        .set_index_status(match &**dafny_value.IndexStatus() {
            crate::r#_Wrappers_Compile::Option::Some { value } => {
                Some(crate::conversions::index_status::from_dafny(value))
            }
            _ => None,
        })
        .set_backfilling(crate::standard_library_conversions::obool_from_dafny(
            dafny_value.Backfilling().clone(),
        ))
        ...
        .set_index_size_bytes(crate::standard_library_conversions::olong_from_dafny(
            dafny_value.IndexSizeBytes().clone(),
        ))
        .set_item_count(crate::standard_library_conversions::olong_from_dafny(
            dafny_value.ItemCount().clone(),
        ))
        .set_index_arn(crate::standard_library_conversions::ostring_from_dafny(
            dafny_value.IndexArn().clone(),
        ))
        .build()
}
