...
,
 TableStatus: ::std::rc::Rc::new(match &value.table_status {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::table_status::to_dafny(x.clone()) },
...
,
 ...
 .set_local_secondary_indexes(match (*dafny_value.LocalSecondaryIndexes()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e: &::std::rc::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::LocalSecondaryIndexDescription>| crate::conversions::local_secondary_index_description::from_dafny(e.clone())
,
            )
        ),
    _ => None
 ...
 .set_global_secondary_indexes(match (*dafny_value.GlobalSecondaryIndexes()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e: &::std::rc::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::GlobalSecondaryIndexDescription>| crate::conversions::global_secondary_index_description::from_dafny(e.clone())
,
            )
        ),
    _ => None
 ...
 .set_replicas(match (*dafny_value.Replicas()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e: &::std::rc::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::ReplicaDescription>| crate::conversions::replica_description::from_dafny(e.clone())
,
            )
        ),
    _ => None
