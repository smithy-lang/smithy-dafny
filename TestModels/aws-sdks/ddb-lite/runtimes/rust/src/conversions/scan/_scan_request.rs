...
,
 ...
 Select: ::std::rc::Rc::new(match &value.select {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::select::to_dafny(x.clone()) },
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_map_to_hashmap(value,
                ...
                |v: &::std::rc::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::Condition>| crate::conversions::condition::from_dafny(v.clone())
,
            )
        ),
    _ => None
