    ...
    aws_sdk_dynamodb::types::ExpectedAttributeValue::builder()
        .set_value(match (*dafny_value.Value()).as_ref() {
            crate::r#_Wrappers_Compile::Option::Some { value } => Some(
                crate::conversions::attribute_value::from_dafny(value.clone()),
            ),
            _ => None,
        })
        .set_exists(crate::standard_library_conversions::obool_from_dafny(
            dafny_value.Exists().clone(),
        ))
        .set_comparison_operator(match &**dafny_value.ComparisonOperator() {
            crate::r#_Wrappers_Compile::Option::Some { value } => {
                Some(crate::conversions::comparison_operator::from_dafny(value))
            }
            _ => None,
        })
