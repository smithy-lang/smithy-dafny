module github.com/smithy-lang/smithy-dafny/kmsv2/test

go 1.23.0

replace github.com/smithy-lang/smithy-dafny/kmsv2 v0.0.0 => ./../../../../kmsv2/runtimes/go/ImplementationFromDafny-go
