...
pub fn to_dafny(
    ...
    crate::implementation_from_dafny::r#_simple_drefinement_dinternaldafny_dtypes::GetRefinementOutput,
> {
    ...
    ::std::rc::Rc::new(crate::implementation_from_dafny::r#_simple_drefinement_dinternaldafny_dtypes::GetRefinementOutput::GetRefinementOutput {
...
pub fn from_dafny(
    ...
    let crate::implementation_from_dafny::r#_simple_drefinement_dinternaldafny_dtypes::GetRefinementOutput::GetRefinementOutput { requiredString, optionalString } = dafny_value.as_ref();
