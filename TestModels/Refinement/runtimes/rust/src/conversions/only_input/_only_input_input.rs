...
pub fn to_dafny(
    ...
    crate::implementation_from_dafny::r#_simple_drefinement_dinternaldafny_dtypes::OnlyInputInput,
> {
    ...
    ::std::rc::Rc::new(crate::implementation_from_dafny::r#_simple_drefinement_dinternaldafny_dtypes::OnlyInputInput::OnlyInputInput {
...
pub fn from_dafny(
    ...
    let crate::implementation_from_dafny::r#_simple_drefinement_dinternaldafny_dtypes::OnlyInputInput::OnlyInputInput { value } = dafny_value.as_ref();
