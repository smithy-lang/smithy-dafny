...
impl Client {
    ...
    pub fn from_conf(
        ...
        Ok(Self {
            dafny_client: ::dafny_runtime::UpcastTo::<dafny_runtime::Object<(dyn ::simple_refinement_dafny::r#_simple_drefinement_dinternaldafny_dtypes::ISimpleRefinementClient + 'static)>>::upcast_to(inner.Extract()),
        })
    }
}
