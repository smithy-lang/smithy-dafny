module github.com/smithy-lang/smithy-dafny/TestModels/RecursiveShape/test
...
require (
	...
	github.com/smithy-lang/smithy-dafny/TestModels/RecursiveShape v0.0.0
)

replace github.com/smithy-lang/smithy-dafny/TestModels/RecursiveShape v0.0.0 => ../ImplementationFromDafny-go
