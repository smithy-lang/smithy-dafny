...
pub fn to_dafny(
    ...
    ::std::rc::Rc::new(match value {
        crate::types::error::Error::PrimaryProjectError { message } =>
    crate::r#simple::multiplemodels::primaryproject::internaldafny::types::Error::PrimaryProjectError {
        message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::string_to_dafny_string(&message),
    },
crate::types::error::Error::DependencyProjectError { error } =>
    crate::r#simple::multiplemodels::primaryproject::internaldafny::types::Error::SimpleMultiplemodelsDependencyproject {
        SimpleMultiplemodelsDependencyproject: crate::deps::simple_multiplemodels_dependencyproject::conversions::error::to_dafny(error),
    },
        crate::types::error::Error::CollectionOfErrors { list, message } =>
            crate::r#simple::multiplemodels::primaryproject::internaldafny::types::Error::CollectionOfErrors {
                message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::string_to_dafny_string(&message),
...
pub fn from_dafny(
    dafny_value: ::std::rc::Rc<
        crate::r#simple::multiplemodels::primaryproject::internaldafny::types::Error,
    >,
) -> crate::types::error::Error {
    match ::std::borrow::Borrow::borrow(&dafny_value) {
        crate::r#simple::multiplemodels::primaryproject::internaldafny::types::Error::PrimaryProjectError { message } =>
    crate::types::error::Error::PrimaryProjectError {
        message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(&message),
    },
crate::r#simple::multiplemodels::primaryproject::internaldafny::types::Error::SimpleMultiplemodelsDependencyproject { SimpleMultiplemodelsDependencyproject } =>
    crate::types::error::Error::DependencyProjectError {
        error: crate::deps::simple_multiplemodels_dependencyproject::conversions::error::from_dafny(SimpleMultiplemodelsDependencyproject.clone()),
    },
        crate::r#simple::multiplemodels::primaryproject::internaldafny::types::Error::CollectionOfErrors { list, message } =>
