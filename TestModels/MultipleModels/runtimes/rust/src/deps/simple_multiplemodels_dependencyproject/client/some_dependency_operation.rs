...
impl crate::deps::simple_multiplemodels_dependencyproject::client::Client {
    ...
    pub fn some_dependency_operation(&self) -> crate::deps::simple_multiplemodels_dependencyproject::operation::some_dependency_operation::builders::SomeDependencyOperationFluentBuilder {
        crate::deps::simple_multiplemodels_dependencyproject::operation::some_dependency_operation::builders::SomeDependencyOperationFluentBuilder::new(self.clone())
    }
}
