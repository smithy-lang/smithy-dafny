...
module {:extern "simple.multiplemodels.dependencyproject.internaldafny" } SimpleMultiplemodelsDependencyprojectService refines AbstractSimpleMultiplemodelsDependencyprojectService {
