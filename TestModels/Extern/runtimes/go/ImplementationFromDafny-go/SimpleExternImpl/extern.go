...
func GetExtern(c Config, input SimpleDafnyExternTypes.GetExternInput) Wrappers.Result {
...
func ExternMustError(c Config, input SimpleDafnyExternTypes.ExternMustErrorInput) Wrappers.Result {
