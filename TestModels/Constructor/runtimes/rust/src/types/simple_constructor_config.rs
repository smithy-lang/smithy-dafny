...
pub struct SimpleConstructorConfigBuilder {
...
impl SimpleConstructorConfigBuilder {
    #[allow(missing_docs)] // documentation missing in model
...
pub fn get_string_value(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`SimpleConstructorConfig`](crate::types::SimpleConstructorConfig).
    pub fn build(
        self,
    ) -> ::std::result::Result<
