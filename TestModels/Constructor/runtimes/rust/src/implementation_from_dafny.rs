              ...
              longValue: ::std::rc::Rc::new(crate::r#_Wrappers_Compile::Option::<i64>::Some {
                ...
                > {
                    ...
                    let mut client = ::dafny_runtime::MaybePlacebo::<
                        ...
                        >,
                    >::new();
                    let mut _nw1: ::dafny_runtime::Object<crate::simple::constructor::internaldafny::SimpleConstructorClient> = crate::simple::constructor::internaldafny::SimpleConstructorClient::_allocate_object();
