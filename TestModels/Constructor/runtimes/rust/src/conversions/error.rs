    ...
    ::std::rc::Rc<crate::r#simple::constructor::internaldafny::types::Error>
{
    ...
    ::std::rc::Rc::new(
        crate::r#simple::constructor::internaldafny::types::Error::Opaque {
            obj: error_obj,
        },
    )
}
...
pub fn to_dafny(
    ...
    ::std::rc::Rc::new(match value {
        ...
        crate::types::error::Error::CollectionOfErrors { list, message } =>
            crate::r#simple::constructor::internaldafny::types::Error::CollectionOfErrors {
...
pub fn from_dafny(
    ...
    match ::std::borrow::Borrow::borrow(&dafny_value) {
        ...
        crate::r#simple::constructor::internaldafny::types::Error::CollectionOfErrors { list, message } =>
