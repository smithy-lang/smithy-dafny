...
impl crate::r#simple::constructor::internaldafny::types::ISimpleConstructorClient for Client {
    fn GetConstructor(
        &mut self,
        input: &std::rc::Rc<
    ...
    >{
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::get_constructor::_get_constructor_output::to_dafny(client),
                },
            ),
        }
    }
