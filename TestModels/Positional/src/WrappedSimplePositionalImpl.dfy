...
module {:options "--function-syntax:4"} {:extern "simplepositionalinternaldafnywrapped"} WrappedSimplePositionalService refines WrappedAbstractSimplePositionalService {
