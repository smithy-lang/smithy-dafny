...
) -> ::std::rc::Rc<crate::implementation_from_dafny::_simple_dpositional_dinternaldafny_dtypes::Error>
{
    ...
    ::std::rc::Rc::new(
    crate::implementation_from_dafny::_simple_dpositional_dinternaldafny_dtypes::Error::Opaque {
        obj: error_obj,
    },
  )
}
...
pub fn to_opaque_error_result<T: dafny_runtime::DafnyType, E: std::error::Error + 'static>(
    ...
    dafny_standard_library::implementation_from_dafny::_Wrappers_Compile::Result<
        T,
        ::std::rc::Rc<
            crate::implementation_from_dafny::_simple_dpositional_dinternaldafny_dtypes::Error,
        >,
    >,
> {
    ::std::rc::Rc::new(
