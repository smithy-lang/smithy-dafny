...
) -> ::std::rc::Rc<crate::implementation_from_dafny::_simple_dpositional_dinternaldafny_dtypes::Error>
{
    ...
    crate::operation::get_resource_positional::GetResourcePositionalError::Unhandled(unhandled) =>
      ::std::rc::Rc::new(crate::implementation_from_dafny::_simple_dpositional_dinternaldafny_dtypes::Error::Opaque { obj: ::dafny_runtime::upcast_object()(::dafny_runtime::object::new(unhandled)) })
  }
}
...
pub fn from_dafny_error(
    ...
    if matches!(&dafny_value.as_ref(), crate::implementation_from_dafny::_simple_dpositional_dinternaldafny_dtypes::Error::CollectionOfErrors { .. }) {
