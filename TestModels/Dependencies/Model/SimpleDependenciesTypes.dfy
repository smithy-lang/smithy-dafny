...
include "../../dafny-dependencies/StandardLibrary/src/Index.dfy"
 ...
 ghost var LocalExtendableResourceAlwaysError: seq<DafnyCallEvent<SimpleExtendableResourcesTypes.GetExtendableResourceErrorsInput, Result<SimpleExtendableResourcesTypes.GetExtendableResourceErrorsOutput, Error>>>
...
// Modifies := {History};
 ...
 predicate LocalExtendableResourceAlwaysErrorEnsuresPublicly(input: SimpleExtendableResourcesTypes.GetExtendableResourceErrorsInput , output: Result<SimpleExtendableResourcesTypes.GetExtendableResourceErrorsOutput, Error>)
 // The public method to be called by library consumers
 method LocalExtendableResourceAlwaysError ( input: SimpleExtendableResourcesTypes.GetExtendableResourceErrorsInput )
 returns (output: Result<SimpleExtendableResourcesTypes.GetExtendableResourceErrorsOutput, Error>)
 requires
 && ValidState()
 modifies Modifies - {History} ,
 History`LocalExtendableResourceAlwaysError
 // Dafny will skip type parameters when generating a default decreases clause.
 decreases Modifies - {History}
 ensures
 && ValidState()
 ensures LocalExtendableResourceAlwaysErrorEnsuresPublicly(input, output)
 ensures History.LocalExtendableResourceAlwaysError == old(History.LocalExtendableResourceAlwaysError) + [DafnyCallEvent(input, output)]
 ...
 requires config.extendableResourceReference.Some? ==> config.extendableResourceReference.value.ValidState()
 modifies if config.extendableResourceReference.Some? then config.extendableResourceReference.value.Modifies else {}
 ensures res.Success? ==> 
 && fresh(res.value)
 && fresh(res.value.History)
 && fresh(res.value.Modifies - Operations.ModifiesInternalConfig(res.value.config))
 && res.value.ValidState()
 ensures !(config.extendableResourceReference.Some?) && res.Success? ==> fresh(Operations.ModifiesInternalConfig(res.value.config))
 ...
 predicate LocalExtendableResourceAlwaysErrorEnsuresPublicly(input: SimpleExtendableResourcesTypes.GetExtendableResourceErrorsInput , output: Result<SimpleExtendableResourcesTypes.GetExtendableResourceErrorsOutput, Error>)
 {Operations.LocalExtendableResourceAlwaysErrorEnsuresPublicly(input, output)}
 // The public method to be called by library consumers
 method LocalExtendableResourceAlwaysError ( input: SimpleExtendableResourcesTypes.GetExtendableResourceErrorsInput )
 returns (output: Result<SimpleExtendableResourcesTypes.GetExtendableResourceErrorsOutput, Error>)
 requires
 ...
 ensures History.LocalExtendableResourceAlwaysError == old(History.LocalExtendableResourceAlwaysError) + [DafnyCallEvent(input, output)]
 {
 output := Operations.LocalExtendableResourceAlwaysError(config, input);
 History.LocalExtendableResourceAlwaysError := History.LocalExtendableResourceAlwaysError + [DafnyCallEvent(input, output)];
}
 ...
 method LocalExtendableResourceAlwaysError ( config: InternalConfig , input: SimpleExtendableResourcesTypes.GetExtendableResourceErrorsInput )
 returns (output: Result<SimpleExtendableResourcesTypes.GetExtendableResourceErrorsOutput, Error>)
 requires
 && ValidInternalConfig?(config)
 modifies ModifiesInternalConfig(config)
