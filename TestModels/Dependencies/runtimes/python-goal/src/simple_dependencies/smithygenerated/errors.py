...
from simple_extendable_resources.smithygenerated.errors import SimpleExtendableResourcesException
...
class SimpleExtendableResources(ApiError[Literal["SimpleExtendableResources"]]):
    simpleExtendableResources: Any
