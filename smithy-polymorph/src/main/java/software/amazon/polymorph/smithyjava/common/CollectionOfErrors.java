...
import static software.amazon.polymorph.smithyjava.common.NativeError.NATIVE_ERROR;
import static software.amazon.polymorph.smithyjava.common.NativeError.THROWABLE_ARGS;
...
public class CollectionOfErrors {
    ...
    static List<FieldSpec> getArgs(String packageName) {
        return List.of(
                FieldSpec.builder(
    ...
    static MethodSpec superBuilder(BuilderSpecs builderSpecs, String packageName) {
