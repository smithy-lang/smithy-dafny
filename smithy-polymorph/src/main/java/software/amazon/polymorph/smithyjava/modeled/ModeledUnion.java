...
public class ModeledUnion {
     ...
     */
    private static final CodeBlock ONLY_ONE_NON_NULL = CodeBlock.builder()
    ...
    public static JavaFile javaFile(String packageName, UnionShape shape, CodegenSubject subject) {
    ...
    protected static MethodSpec unionValidate(UnionShape shape) {
        ...
        return MethodSpec.methodBuilder(UNION_VALIDATE_METHOD_NAME)
                .returns(boolean.class)
                .addModifiers(Modifier.PRIVATE)
                .addStatement("$T[] $L = {$L}",
                        Object.class, ALL_FIELDS_VAR,
