...
public class ToNativeConstants {
    ...
    static String OTHER_NAMESPACE_CONVERSION = "software.amazon.awssdk.other.ToNative.OtherNamespace";
    static String INIT_TEMP_ARRAY = "software.amazon.awssdk.services.kms.model.KeyUsageType[] listEnum_temp = new software.amazon.awssdk.kms.model.KeyUsageType[dafnyValue.dtor_listEnum().length()]";
    ...
    static String KEY_USAGE_TYPE = """
              public static software.amazon.awssdk.kms.model.KeyUsageType KeyUsageType(
                      Dafny.Com.Amazonaws.Kms.Types.KeyUsageType dafnyValue
              ) {
                if (dafnyValue.is_SIGN__VERIFY()) {
                  return software.amazon.awssdk.kms.model.KeyUsageType.SIGN_VERIFY;
                }
                if (dafnyValue.is_ENCRYPT__DECRYPT()) {
                  return software.amazon.awssdk.kms.model.KeyUsageType.ENCRYPT_DECRYPT;
                }
                return software.amazon.awssdk.kms.model.KeyUsageType.fromValue(dafnyValue.toString());
              }""";
    static String GENERATE_CONVERT_LIST = """
            public static java.util.List<software.amazon.awssdk.kms.model.KeyUsageType> KeyUsageTypes(
    ...
    static String SIMPLE_STRUCTURE = """
            public static software.amazon.awssdk.kms.model.Simple Simple(
              Dafny.Com.Amazonaws.Kms.Types.Simple dafnyValue
            ) {
              return new software.amazon.awssdk.kms.model.Simple();
            }
            """;
    static String A_OPTIONAL_STRUCTURE = """
            public static software.amazon.awssdk.kms.model.AOptional AOptional(
              Dafny.Com.Amazonaws.Kms.Types.AOptional dafnyValue
            ) {
              software.amazon.awssdk.kms.model.AOptional converted = new software.amazon.awssdk.kms.model.AOptional();
    ...
    static String REQUIRED_LIST_ENUM_STRUCTURE = """
            public static software.amazon.awssdk.kms.model.RequiredListEnum RequiredListEnum(
              Dafny.Com.Amazonaws.Kms.Types.RequiredListEnum dafnyValue
            ) {
              software.amazon.awssdk.kms.model.RequiredListEnum converted = new software.amazon.awssdk.kms.model.RequiredListEnum();
              %s;
              %s;
              return converted;
            }
    ...
    static String KMS_A_STRING_OPERATION_JAVA_FILE = """
            ...
            import software.amazon.awssdk.kms.model.DoSomethingRequest;
