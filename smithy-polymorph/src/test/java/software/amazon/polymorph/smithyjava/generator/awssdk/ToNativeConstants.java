...
public class ToNativeConstants {
    ...
    static String SET_WITH_CONVERSION_CALL = "converted.withCiphertext(software.amazon.dafny.conversion.ToNative.Simple.ByteBuffer(dafnyValue.Ciphertext))";
    static String SET_WITH_CONVERSION_CALL_AND_TO_ARRAY = "converted.withListEnum(Dafny.Com.Amazonaws.Kms.ToNative.KeyUsageTypes(dafnyValue.ListEnum).toArray(listEnum_temp))";
    ...
    static String KMS_A_STRING_OPERATION_JAVA_FILE = """
            ...
            public class ToNative {
              public static DoSomethingRequest DoSomethingRequest(
                ...
                converted.withMessage(%s(dafnyValue.Message));
                return converted;
              }
            }
