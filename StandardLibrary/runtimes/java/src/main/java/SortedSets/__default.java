...
public class __default {
  ...
  public static <T> dafny.DafnySequence<
    ? extends dafny.DafnySequence<? extends T>
  > SetToOrderedSequence(
    ...
    dafny.DafnySequence<? extends T>[] outputArray =
      new DafnySequence[inputSet.size()];
    ...
    return DafnySequence.fromRawArray(
      DafnySequence._typeDescriptor(td_T),
      outputArray
    );
  }
  ...
  public static <T> dafny.DafnySequence<? extends T> SetToSequence(
    dafny.TypeDescriptor<T> td_T,
...
class LexicographicComparer<T>
  implements Comparator<dafny.DafnySequence<? extends T>> {
  ...
  public int compare(
    dafny.DafnySequence<? extends T> x,
    dafny.DafnySequence<? extends T> y
  ) {
