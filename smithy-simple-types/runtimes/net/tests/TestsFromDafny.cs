...
// Command Line Options: -vcsCores:2 -compileTarget:cs -spillTargetCode:3 -runAllTests:1 -compile:0 -useRuntimeLib -out runtimes/net/tests/TestsFromDafny ./test/SimpleTypesImplTest.dfy -library:src/Index.dfy
// the_program
...
namespace SimpleTypesImplTest_Compile {

  public partial class __default {
    public static void GetString()
    {
      Dafny.Example.Simpletypes.SimpleTypesClient _0_client;
      Wrappers_Compile._IResult<Dafny.Example.Simpletypes.SimpleTypesClient, Dafny.Example.Simpletypes.Types._IError> _1_valueOrError0 = default(Wrappers_Compile._IResult<Dafny.Example.Simpletypes.SimpleTypesClient, Dafny.Example.Simpletypes.Types._IError>);
      Wrappers_Compile._IResult<Dafny.Example.Simpletypes.SimpleTypesClient, Dafny.Example.Simpletypes.Types._IError> _out0;
      _out0 = Dafny.Example.Simpletypes.__default.SimpleTypes(Dafny.Example.Simpletypes.__default.DefaultEmptyConfig());
      _1_valueOrError0 = _out0;
      if (!(!((_1_valueOrError0).IsFailure()))) {
        throw new Dafny.HaltException("/Users/scchatur/workspace/polymorph/smithy-simple-types/test/SimpleTypesImplTest.dfy(7,19): " + _1_valueOrError0);
      }
      _0_client = (_1_valueOrError0).Extract();
      Wrappers_Compile._IResult<Wrappers_Compile._IOption<Dafny.ISequence<char>>, Dafny.Example.Simpletypes.Types._IError> _2_ret;
      Wrappers_Compile._IResult<Wrappers_Compile._IOption<Dafny.ISequence<char>>, Dafny.Example.Simpletypes.Types._IError> _out1;
      _out1 = (_0_client).GetString(Wrappers_Compile.Option<Dafny.ISequence<char>>.create_Some(Dafny.Sequence<char>.FromString("S")));
      _2_ret = _out1;
      if (!((_2_ret).is_Failure)) {
        throw new Dafny.HaltException("/Users/scchatur/workspace/polymorph/smithy-simple-types/test/SimpleTypesImplTest.dfy(9,3): " + Dafny.Sequence<char>.FromString("expectation violation"));
      }
      Dafny.Helpers.Print((_2_ret));
    }
  }
} // end of namespace SimpleTypesImplTest_Compile
namespace _module {
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> __noArgsParameter)
    {
      bool _3_success;
      _3_success = true;
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"SimpleTypesImplTest.GetString: ")));
      try {
        {
          SimpleTypesImplTest_Compile.__default.GetString();
          {
...
")));
        ...
        var _4_haltMessage = Dafny.Sequence<char>.FromString(e.Message);
        {
          Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"FAILED
	")));
          Dafny.Helpers.Print((_4_haltMessage));
...
")));
      ...
      if (!(_3_success)) {
        throw new Dafny.HaltException("/Users/scchatur/workspace/polymorph/smithy-simple-types/test/SimpleTypesImplTest.dfy(6,18): " + Dafny.Sequence<char>.FromString(@"Test failures occurred: see above.
"));
      }
    }
  }
