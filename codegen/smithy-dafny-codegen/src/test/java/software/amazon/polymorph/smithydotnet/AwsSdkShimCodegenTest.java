...
public class AwsSdkShimCodegenTest {
    ...
    public void testGenerateOperationShim() {
        ...
        final String resultTypeParams = "%s, %s".formatted(
                "software.amazon.cryptography.services.foobar.internaldafny.types._IGoResponse", "software.amazon.cryptography.services.foobar.internaldafny.types._IError");
