...
public final class SymbolUtils {
  ...
  public static Symbol.Builder createValueSymbolBuilder(String typeName) {
    return Symbol.builder().putProperty(POINTABLE, false).name(typeName);
  }
  ...
  public static Symbol.Builder createPointableSymbolBuilder(String typeName) {
    return Symbol.builder().putProperty(POINTABLE, true).name(typeName);
  }
   ...
   * @return the symbol builder.
   */
  public static Symbol.Builder createValueSymbolBuilder(
    Shape shape,
    String typeName
  ) {
   ...
   * @return the symbol builder.
   */
  public static Symbol.Builder createPointableSymbolBuilder(
    Shape shape,
    String typeName
  ) {
  ...
  public static Symbol.Builder createPointableSymbolBuilder(
    ...
    return createPointableSymbolBuilder(shape, typeName)
      .namespace(namespace, ".");
  }
  ...
  public static Symbol.Builder createPointableSymbolBuilder(
    ...
    return setImportedNamespace(
      createPointableSymbolBuilder(shape, typeName),
      namespace
    );
  }
  ...
  public static Symbol.Builder createValueSymbolBuilder(
    ...
    return setImportedNamespace(
      createValueSymbolBuilder(shape, typeName),
      namespace
    );
  }
  ...
  public static Symbol.Builder createPointableSymbolBuilder(
    ...
    return setImportedNamespace(
      createPointableSymbolBuilder(typeName),
      namespace
    );
  }
  ...
  private static Symbol.Builder setImportedNamespace(
    Symbol.Builder builder,
    GoDependency dependency
  ) {
    return builder
      .namespace(dependency.getImportPath(), ".")
