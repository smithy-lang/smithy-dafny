...
//  /**
//   * Writes code modelling the provided StructureShape. This relies on a fork of Smithy-Python which
//   * makes its StructureGenerator public. Smithy-Python does not generate code to model shapes that
//   * are not used by the service under generation. Polymorph takes Smithy-Python's
//   * StructureGenerator and executes it for these shapes, as it must generate code modelling shapes
//   * that are not directly used by the service under generation. (Services that rely on this service
//   * may still use these operations/shapes.)
//   *
//   * @param structureShape
//   * @param codegenContext
//   */
//  private void writeStructureShape(
//      StructureShape structureShape, GenerationContext codegenContext) {
//    if (structureShape
//        .getId()
//        .getNamespace()
