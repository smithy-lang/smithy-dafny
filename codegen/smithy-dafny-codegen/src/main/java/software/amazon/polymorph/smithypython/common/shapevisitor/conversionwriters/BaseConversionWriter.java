package software.amazon.polymorph.smithypython.common.shapevisitor.conversionwriters;
...
public abstract class BaseConversionWriter {
  ...
  public abstract void writeStructureShapeConverter(StructureShape structureShape,
      GenerationContext context,
      PythonWriter writer, String filename);

  public abstract void writeUnionShapeConverter(UnionShape unionShape, GenerationContext context,
      PythonWriter writer, String filename);
}
