...
public class LocalServiceToDafnyConversionFunctionWriter extends BaseConversionWriter {
              ...
              () -> {
                if (Utils.isUnitShape(structureShape.getId())) {
                  ...
                  writeReferenceStructureShapeConverter(
                      structureShape, conversionWriter, dataSourceInsideConversionFunction);
        ...
        () -> {
          ...
          for (Entry<String, MemberShape> memberShapeEntry : shape.getAllMembers().entrySet()) {
            ...
            writeNonReferenceStructureShapeMemberConverter(
                conversionWriter, dataSourceInsideConversionFunction, memberName, memberShape);
          }
        });
  }
  ...
  private void writeNonReferenceStructureShapeMemberConverter(
    ...
    //   an empty optional at runtime
      ...
      conversionWriter.addStdlibImport(
          "standard_library.internaldafny.generated.Wrappers", "Option_Some");
      conversionWriter.addStdlibImport(
          "standard_library.internaldafny.generated.Wrappers", "Option_None");
      conversionWriter.write(
  ...
  protected void writeServiceShapeConverter(
    ...
    if (serviceShape.hasTrait(LocalServiceTrait.class)) {
      conversionWriter.write(
          "return $L._config.dafnyImplInterface.impl", dataSourceInsideConversionFunction);
  ...
  protected void writeResourceShapeConverter(
    ...
    conversionWriter.openBlock(
        ...
        dataSourceInsideConversionFunction,
        () -> {
          conversionWriter.write("return $L._impl", dataSourceInsideConversionFunction);
        });
                ...
                for (MemberShape memberShape : unionShape.getAllMembers().values()) {
                  ...
                  conversionWriter.write(
                      ...
                      SmithyNameResolver.getSmithyGeneratedTypeForUnion(
                          unionShape, memberShape, context),
                  ...
                  SmithyNameResolver.importSmithyGeneratedTypeForShape(
                      conversionWriter, unionShape, context);
                }
        ...
        conversionWriter -> {
          ...
          conversionWriter.openBlock(
              ...
              SmithyNameResolver.getSmithyToDafnyFunctionNameForShape(
                  stringShapeWithEnumTrait, context),
              dataSourceInsideConversionFunction,
              () -> {
                ...
                for (EnumDefinition enumDefinition :
                  ...
                  String name =
                      enumDefinition.getName().isPresent()
