...
public class ConstrainTraitUtils {
    ...
    public static boolean hasRequiredTrait(Shape shape) { return shape.hasTrait(RequiredTrait.class); }

    public static boolean hasRangeTrait(Shape shape) { return shape.hasTrait(RangeTrait.class); }

    public static boolean hasLengthTrait(Shape shape) { return shape.hasTrait(LengthTrait.class); }

    public static boolean hasConstraintTrait(Shape shape) {
        return hasRequiredTrait(shape) || hasRangeTrait(shape) || hasLengthTrait(shape);
    }
