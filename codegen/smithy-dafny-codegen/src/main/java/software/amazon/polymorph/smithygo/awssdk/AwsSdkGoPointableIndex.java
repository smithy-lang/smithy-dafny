...
public class AwsSdkGoPointableIndex implements KnowledgeIndex {
    ...
    private static final Logger LOGGER = Logger.getLogger(AwsSdkGoPointableIndex.class.getName());
    ...
    public AwsSdkGoPointableIndex(Model model, NullableIndex.CheckMode checkMode) {
        this.model = model;
    ...
    public static AwsSdkGoPointableIndex of(Model model) {
        return model.getKnowledge(AwsSdkGoPointableIndex.class, AwsSdkGoPointableIndex::new);
    }

    public static AwsSdkGoPointableIndex of(Model model, NullableIndex.CheckMode checkMode) {
        return model.getKnowledge(AwsSdkGoPointableIndex.class, (model1) -> new AwsSdkGoPointableIndex(model1, checkMode));
    }
