    ...
    delegator.useFileWriter(
        ...
        conversionWriter -> {
          ...
          conversionWriter.openBlock(
              "def $L($L):",
              "",
              AwsSdkNameResolver.getDafnyToAwsSdkFunctionNameForShape(stringShapeWithEnumTrait),
              dataSourceInsideConversionFunction,
              () -> {
                conversionWriter.writeComment(
                    "Convert %1$s".formatted(stringShapeWithEnumTrait.getId().getName()));
                ...
                for (final EnumDefinition enumDefinition :
                  ...
                  """,
                      ...
                      DafnyNameResolver.getDafnyTypeForStringShapeWithEnumTrait(
                          stringShapeWithEnumTrait, value),
                      value);
                  shouldOpenNewIfBlock = false;
