...
public interface ProtocolGenerator {
   ...
   * @param context Serde context.
   */
  default void generateSharedDeserializerComponents(
   ...
   */
  static String getOperationHttpBindingsSerFunctionName(
    Shape shape,
    ServiceShape service,
    String protocol
  ) {
   ...
   * @return Returns the generated function name.
   */
  static String getOperationHttpBindingsDeserFunctionName(
    Shape shape,
    ServiceShape service,
    String protocol
  ) {
   ...
   * @return Returns the generated function name.
   */
  static String getDocumentSerializerFunctionName(
    Shape shape,
    ServiceShape service,
    String protocol
  ) {
   ...
   * @return Returns the generated function name.
   */
  static String getDocumentDeserializerFunctionName(
    Shape shape,
    ServiceShape service,
    String protocol
  ) {
  ...
  static String getOperationErrorDeserFunctionName(
   ...
   * @return Returns the generated function name.
   */
  static String getErrorDeserFunctionName(
  ...
  static String getSerializeMiddlewareName(
    ShapeId operationShapeId,
    ServiceShape service,
    String protocol
  ) {
    return protocol + "_serializeOp" + operationShapeId.getName(service);
  }

  static String getDeserializeMiddlewareName(
    ShapeId operationShapeId,
    ServiceShape service,
    String protocol
  ) {
    return protocol + "_deserializeOp" + operationShapeId.getName(service);
  }
   ...
   * @param context the generation context.
   */
  default void generateProtocolDocumentMarshalerUnmarshalDocument(
    GenerationContext context
  ) {
    throw new CodegenException(
      "document types not implemented for " +
   ...
   * @param context the generation context.
   */
  default void generateProtocolDocumentMarshalerMarshalDocument(
    GenerationContext context
  ) {
    throw new CodegenException(
      "document types not implemented for " +
   ...
   * @param context the generation context.
   */
  default void generateProtocolDocumentUnmarshalerUnmarshalDocument(
    GenerationContext context
  ) {
    throw new CodegenException(
      "document types not implemented for " +
   ...
   * @param context the generation context.
   */
  default void generateProtocolDocumentUnmarshalerMarshalDocument(
    GenerationContext context
  ) {
    throw new CodegenException(
      "document types not implemented for " +
   ...
   */
  default void generateNewDocumentMarshaler(
    GenerationContext context,
    Symbol marshalerSymbol
  ) {
   ...
   */
  default void generateNewDocumentUnmarshaler(
    GenerationContext context,
    Symbol unmarshalerSymbol
  ) {
    GoWriter writer = context.getWriter().get();
    writer.openBlock(
      "return &$T{",
  ...
  class GenerationContext {
    ...
    private GenerationContext(Builder builder) {
      ...
      this.protocolName =
        SmithyBuilder.requiredState("protocolName", builder.protocolName);
      this.delegator =
        SmithyBuilder.requiredState("delegator", builder.delegator);
    }
