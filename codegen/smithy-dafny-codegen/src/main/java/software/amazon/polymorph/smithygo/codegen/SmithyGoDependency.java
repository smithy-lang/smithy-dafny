...
public final class SmithyGoDependency {
  ...
  public static final GoDependency CRYPTORAND = stdlib(
    "crypto/rand",
    "cryptorand"
  );
  ...
  public static final GoDependency SMITHY_HTTP_TRANSPORT = smithy(
    "transport/http",
    "smithyhttp"
  );
  ...
  public static final GoDependency SMITHY_HTTP_BINDING = smithy(
    "encoding/httpbinding"
  );
  public static final GoDependency SMITHY_JSON = smithy(
    "encoding/json",
    "smithyjson"
  );
  public static final GoDependency SMITHY_XML = smithy(
    "encoding/xml",
    "smithyxml"
  );
  ...
  public static final GoDependency SMITHY_TESTING = smithy(
    "testing",
    "smithytesting"
  );
  public static final GoDependency SMITHY_WAITERS = smithy(
    "waiter",
    "smithywaiter"
  );
  public static final GoDependency SMITHY_DOCUMENT = smithy(
    "document",
    "smithydocument"
  );
  public static final GoDependency SMITHY_DOCUMENT_JSON = smithy(
    "document/json",
    "smithydocumentjson"
  );
  ...
  public static GoDependency stdlib(String importPath) {
    return GoDependency.standardLibraryDependency(
      importPath,
      Versions.GO_STDLIB
    );
  }
  ...
  private static GoDependency goJmespath(String relativePath) {
    return relativePackage(
      GO_JMESPATH_SOURCE_PATH,
      relativePath,
      Versions.GO_JMESPATH,
      null
    );
  }
  ...
  private static GoDependency relativePackage(
    ...
    return GoDependency.moduleDependency(
      moduleImportPath,
      importPath,
      version,
      alias
