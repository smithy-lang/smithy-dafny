...
public class NativeWrapper extends ResourceShim {
    ...
    TypeSpec nativeWrapper() {
        ...
        TypeSpec.Builder spec =TypeSpec
                ...
                .addField(interfaceName, ShimLibrary.INTERFACE_FIELD, PRIVATE, FINAL)
    ...
    MethodSpec nativeWrapperConstructor() {
        ...
        return MethodSpec
                ...
                .endControlFlow()
                .addStatement("this.$L = $L", ShimLibrary.INTERFACE_FIELD, paramName)
                .build();
    }
    ...
    protected TypeName methodInputSignatureTypeName(ModelUtils.ResolvedShapeId resolvedShape) {
    ...
    /** @return TypeName for a method's signature. */
    protected TypeName methodOutputTypeName(ModelUtils.ResolvedShapeId resolvedShape) {
        Shape shape = subject.model.expectShape(resolvedShape.resolvedId());
    ...
    protected CodeBlock nativeDeclareAndConvert(ModelUtils.ResolvedShapeId resolvedShape) {
    ...
    protected CodeBlock declareNativeOutputAndInvoke(ModelUtils.ResolvedShapeId resolvedShape, String operationName) {
    ...
    protected CodeBlock invoke(String operationName) {
      return CodeBlock.of("this.$L.$L($L)",
              ShimLibrary.INTERFACE_FIELD, operationName, NATIVE_INPUT);
    }

    protected CodeBlock declareDafnyOutputAndConvert(ModelUtils.ResolvedShapeId resolvedShape) {
