...
/**
 * Contains utility functions that map Smithy shapes to an expected
 *   corresponding string generated by Dafny's Python compiler.
 * i.e. strings in this file match behavior of Dafny-generated code.
 */
