...
public class Generator {
    ...
    private static RustFile errorConversionModule(final ServiceShape service, final Shape errorStructure) {
        String snakeCaseName = toSnakeCase(errorStructure.getId().getName());
        Path path = Path.of("conversions", "error", snakeCaseName + ".rs");
        String template = """
        // Code generated by software.amazon.smithy.rust.codegen.smithy-rs. DO NOT EDIT.
        
        #[allow(dead_code)]
        pub fn to_dafny(
            value: $sdkCrate:L::types::error::$structureName,
        ) -> ::std::rc::Rc<crate::implementation_from_dafny::r#$dafnyTypesModuleName::Error>{
          ::std::rc::Rc::new(
            crate::implementation_from_dafny::r#_software_damazon_dcryptography_dservices_dkms_dinternaldafny_dtypes::Error::$structureName {
