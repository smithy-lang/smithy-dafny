...
public class DafnyAwsSdkClientTypeConversionProtocol
    ...
    serviceShape
        ...
        .forEach(eachOperation -> {
          ...
          if (!alreadyVisited.contains(awsNormalizedInputShape.toShapeId())) {
            ...
            if (!awsNormalizedInputShape.hasTrait(UnitTypeTrait.class) &&
                awsNormalizedInputShape
                    .toShapeId()
                    .getNamespace()
                    .equals(serviceShape.toShapeId().getNamespace())) {
              final var awsNormalizedInputToDafnyMethodName = SmithyNameResolver.getToDafnyMethodName(
                  serviceShape,
                  awsNormalizedInputShape,
                  "");
                  ...
                  writer -> {
                    ...
                    writer.write(
                        ...
                        DafnyNameResolver.getDafnyType(
                            dafnyNonNormalizedModel.expectShape(dafnyInput),
                            dafnyInputSymbol),
                        writer.consumer(w -> generateRequestSerializer(
                            context,
          ...
          if (!alreadyVisited.contains(awsNormalizedOutputShape.toShapeId())) {
            ...
            if (!awsNormalizedOutputShape.hasTrait(UnitTypeTrait.class) &&
                awsNormalizedOutputShape
                    ...
                    .getNamespace()
                    .equals(serviceShape.toShapeId().getNamespace())) {
              final var awsNormalizedOutputToDafnyMethodName = SmithyNameResolver.getToDafnyMethodName(
                  serviceShape,
                  awsNormalizedOutputShape,
                  "");
                  ...
                  writer -> {
                    ...
                    writer.write(
                        ...
                        DafnyNameResolver.getDafnyType(
                            dafnyNonNormalizedModel.expectShape(dafnyOutput),
                            dafnyOutputSymbol),
                        writer.consumer(w -> generateResponseSerializer(
                            context,
                            awsNormalizedOperation,
                            context.writerDelegator())));
                  });
          ...
          if (!alreadyVisited.contains(awsNormalizedInputShape.toShapeId())) {
            ...
            if (!awsNormalizedInputShape.hasTrait(UnitTypeTrait.class) &&
                awsNormalizedInputShape
                    ...
                    .getNamespace()
                    .equals(serviceShape.toShapeId().getNamespace())) {
              final var awsNormalizedInputFromDafnyMethodName = SmithyNameResolver.getFromDafnyMethodName(
                  serviceShape,
                  awsNormalizedInputShape,
                  "");
              final var awsNormalizedInputSymbol = symbolProvider.toSymbol(
                  ...
                  writer -> {
                    ...
                    writer.write(
                        ...
                        SmithyNameResolver.getSmithyTypeAws(
                            ...
                            awsNormalizedInputSymbol,
                            false),
                        writer.consumer(w -> generateRequestDeserializer(
                            context,
          ...
          if (!alreadyVisited.contains(awsNormalizedOutputShape.toShapeId())) {
            ...
            if (!awsNormalizedOutputShape.hasTrait(UnitTypeTrait.class) &&
                awsNormalizedOutputShape
                    ...
                    .getNamespace()
                    .equals(serviceShape.toShapeId().getNamespace())) {
              final var awsNormalizedOutputFromDafnyMethodName = SmithyNameResolver.getFromDafnyMethodName(
                  serviceShape,
                  awsNormalizedOutputShape,
                  "");
                  ...
                  writer -> {
                    ...
                    writer.write(
                        ...
                        SmithyNameResolver.getSmithyTypeAws(
                            ...
                            awsNormalizedOutputSymbol,
                            false),
                        writer.consumer(w -> generateResponseDeserializer(
                            context,
                            awsNormalizedOperationShape,
                            context.writerDelegator())));
                  });
  ...
  private void generateErrorDeserializer(final GenerationContext context) {
    ...
    for (final var errorShape : errorShapes) {
      ...
      if (!alreadyVisited.contains(errorShape.toShapeId())) {
        alreadyVisited.add(errorShape.toShapeId());
        final var getOutputFromDafnyMethodName = SmithyNameResolver.getFromDafnyMethodName(
            serviceShape,
            errorShape,
            "");
        context
  ...
  // But since this runs outside of any production code - we are okay with this
  // for now
  private void generateSerializerFunctions(final GenerationContext context, final Set<ShapeId> alreadyVisited) {
    final var writerDelegator = context.writerDelegator();
    writerDelegator.useFileWriter("%s/%s".formatted(SmithyNameResolver.shapeNamespace(serviceShape), TO_DAFNY),
        SmithyNameResolver.shapeNamespace(serviceShape),
        writer -> {
    ...
    delegator.useFileWriter(
        ...
        writer -> {
          ...
          for (final var visitingMemberShape : DafnyToAwsSdkShapeVisitor.getAllShapesRequiringConversionFunc()) {
            ...
            alreadyVisited.add(visitingMemberShape.toShapeId());
            var outputType = SmithyNameResolver.getSmithyTypeAws(serviceTrait,
                context.symbolProvider().toSymbol(visitingShape), true);
            switch (visitingShape.getType()) {
              case STRUCTURE:
              case UNION:
                if (visitingShape.hasTrait(EnumTrait.class)) {
                  outputType = SmithyNameResolver.getSmithyTypeAws(serviceTrait,
                      context.symbolProvider().toSymbol(visitingShape), true);
                }
                break;
              case LIST:
            ...
            if (ShapeVisitorHelper.isToNativeShapePointable(visitingMemberShape)) {
